...
class ControllerContentBanner extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_banner_list')) ? $this->config->get('default_admin_view_banner_list') : 'content/banner_list.tpl';
    ...
    public function grid() {
        ...
        $banner_total = $this->modelBanner->getAllTotal($data);
        ...
        $template = ($this->config->get('default_admin_view_banner_grid')) ? $this->config->get('default_admin_view_banner_grid') : 'content/banner_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        $template = ($this->config->get('default_admin_banner_form')) ? $this->config->get('default_admin_view_banner_form') : 'content/banner_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
