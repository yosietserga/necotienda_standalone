 ...
 * @copyright 2010
 */
class ControllerEmailBounce extends Controller {
    ...
    public function index() {
        $this->load->language('email/bounce');

        $this->document->title = $this->language->get('heading_title');

        $this->load->model('email/bounce');
        ...
        $this->session->data['bounce_details'] = $bounce_details;
        ...
        if (!$fp) {
            ...
            $this->data['porcentaje'] = 'jQuery("#progressbar").progressBar(70,{barImage : {
                                                                            		0:  \'' . HTTPS_SERVER . 'view/image/progressbg_red.gif\',
                                                                            		30: \'' . HTTPS_SERVER . 'view/image/progressbg_orange.gif\',
                                                                            		80: \'' . HTTPS_SERVER . 'view/image/progressbg_green.gif\'
                                                                            	       }
                                                                                    });';
        } else {
            $login_ok = $this->Login();
        ...
        $this->template = 'email/bounce_test.tpl';
    ...
    function Login() {
        $bounce_details = $this->session->data['bounce_details'];
        $arrConections = array();
