...
class ControllerLocalisationCountry extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_country_list')) ? $this->config->get('default_admin_view_country_list') : 'localisation/country_list.tpl';
    ...
    private function getForm() {
        ...
        $template = ($this->config->get('default_admin_view_country_form')) ? $this->config->get('default_admin_view_country_form') : 'localisation/country_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function validateDelete() {
        ...
        foreach ($this->request->post['selected'] as $country_id) {
            ...
            $zone_total = $this->model_localisation_zone->getAllTotal(array(
