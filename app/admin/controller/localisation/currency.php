...
class ControllerLocalisationCurrency extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_currency_list')) ? $this->config->get('default_admin_view_currency_list') : 'localisation/currency_list.tpl';
    ...
    public function grid() {
        ...
        $template = ($this->config->get('default_admin_view_currency_grid')) ? $this->config->get('default_admin_view_currency_grid') : 'localisation/currency_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        if (isset($this->request->post['description'])) {
            ...
            $this->data['description'] = $this->modelCurrency->getDescriptions($this->request->get['currency_id']);
        } else {
            $this->data['description'] = array();
        }

        $template = ($this->config->get('default_admin_view_currency_form')) ? $this->config->get('default_admin_view_currency_form') : 'localisation/currency_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
