...
class ControllerLocalisationGeoZone extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_geo_zone_list')) ? $this->config->get('default_admin_view_geo_zone_list') : 'localisation/geo_zone_list.tpl';
    ...
    public function grid() {
        ...
        $template = ($this->config->get('default_admin_view_geo_zone_grid')) ? $this->config->get('default_admin_view_geo_zone_grid') : 'localisation/geo_zone_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        if (isset($this->request->get['geo_zone_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $geo_zone_info = $this->modelGeozone->getByID($this->request->get['geo_zone_id']);
        }
        ...
        $template = ($this->config->get('default_admin_view_geo_zone_form')) ? $this->config->get('default_admin_view_geo_zone_form') : 'localisation/geo_zone_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
