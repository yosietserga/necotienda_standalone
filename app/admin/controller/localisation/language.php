...
class ControllerLocalisationLanguage extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_language_list')) ? $this->config->get('default_admin_view_language_list') : 'localisation/language_list.tpl';
    ...
    public function grid() {
        ...
        $template = ($this->config->get('default_admin_view_language_grid')) ? $this->config->get('default_admin_view_language_grid') : 'localisation/language_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        $template = ($this->config->get('default_admin_view_language_form')) ? $this->config->get('default_admin_view_language_form') : 'localisation/language_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
