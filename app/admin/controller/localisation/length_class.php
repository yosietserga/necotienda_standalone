...
class ControllerLocalisationLengthClass extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_length_class_list')) ? $this->config->get('default_admin_view_length_class_list') : 'localisation/length_class_list.tpl';
    ...
    public function grid() {
        ...
        $length_class_total = $this->modelLengthclass->getAllTotal($data);
        ...
        $i = str_replace('%theme%',$this->config->get('config_admin_template'),HTTP_ADMIN_THEME_IMAGE);
            foreach ($results as $result) {
                ...
                $this->data['length_classes'][] = array(
                    ...
                    'title' => $result['title'] . (($result['description'] == $this->config->get('config_length_class')) ? $this->language->get('text_default') : NULL),
        ...
        $this->data['sort_description'] = Url::createAdminUrl('localisation/length_class/grid') . '&sort=description' . $url;
        ...
        $template = ($this->config->get('default_admin_view_length_class_grid')) ? $this->config->get('default_admin_view_length_class_grid') : 'localisation/length_class_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        $template = ($this->config->get('default_admin_view_length_class_form')) ? $this->config->get('default_admin_view_length_class_form') : 'localisation/length_class_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function validateDelete() {
        ...
        foreach ($this->request->post['selected'] as $length_class_id) {
            ...
            if ($length_class_info && ($this->config->get('config_length_class') == $length_class_info['description'])) {
