...
class ControllerLocalisationOrderStatus extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_order_status_list')) ? $this->config->get('default_admin_view_order_status_list') : 'localisation/order_status_list.tpl';
    ...
    public function grid() {
        ...
        $template = ($this->config->get('default_admin_view_order_status_grid')) ? $this->config->get('default_admin_view_order_status_grid') : 'localisation/order_status_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        $template = ($this->config->get('default_admin_view_order_status_form')) ? $this->config->get('default_admin_view_order_status_form') : 'localisation/order_status_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
