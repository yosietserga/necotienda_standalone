...
class ControllerLocalisationStockStatus extends Controller {
    ...
    public function insert() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $stock_status_id = $this->modelStockstatus->add($this->request->post);
    ...
    public function update() {
        $this->document->title = $this->language->get('heading_title');
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->modelStockstatus->update($this->request->get['stock_status_id'], $this->request->post);
    ...
    public function delete() {
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $this->modelStockstatus->delete($_GET['id']);
        }
    }
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_stock_status_list')) ? $this->config->get('default_admin_view_stock_status_list') : 'localisation/stock_status_list.tpl';
    ...
    public function grid() {
        ...
        $template = ($this->config->get('default_admin_view_stock_status_grid')) ? $this->config->get('default_admin_view_stock_status_grid') : 'localisation/stock_status_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        $template = ($this->config->get('default_admin_view_stock_status_form')) ? $this->config->get('default_admin_view_stock_status_form') : 'localisation/stock_status_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
