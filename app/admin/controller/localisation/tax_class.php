...
class ControllerLocalisationTaxClass extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_tax_class_list')) ? $this->config->get('default_admin_view_tax_class_list') : 'localisation/tax_class_list.tpl';
    ...
    public function grid() {
        ...
        $template = ($this->config->get('default_admin_view_tax_class_grid')) ? $this->config->get('default_admin_view_tax_class_grid') : 'localisation/tax_class_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        $template = ($this->config->get('default_admin_view_tax_class_form')) ? $this->config->get('default_admin_view_tax_class_form') : 'localisation/tax_class_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
