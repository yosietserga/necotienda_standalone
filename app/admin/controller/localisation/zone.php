...
class ControllerLocalisationZone extends Controller {
    ...
    private function getList() {
        ...
        $zone_total = $this->model_localisation_zone->getAllTotal($data);
        ...
        $template = ($this->config->get('default_admin_view_zone_list')) ? $this->config->get('default_admin_view_zone_list') : 'localisation/zone_list.tpl';
    ...
    private function getForm() {
        ...
        $template = ($this->config->get('default_admin_view_zone_form')) ? $this->config->get('default_admin_view_zone_form') : 'localisation/zone_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
