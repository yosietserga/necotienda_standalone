    ...
    public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            if ($this->request->post['to'] == "saveAndKeep") {
                $this->redirect(Url::createAdminUrl('marketing/contact/update',array('contact_id'=>$contact_id))); 
            } elseif ($this->request->post['to'] == "saveAndNew") {
                $this->redirect(Url::createAdminUrl('marketing/contact/insert')); 
            } else {
                $this->redirect(Url::createAdminUrl('marketing/contact')); 
            }
		}
