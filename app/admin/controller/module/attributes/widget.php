...
/**
 * ControllerModuleAttributesWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleAttributesWidget extends Controller {

    private $error = array();

    /**
     * ControllerModuleAttributesWidget::index()
     * 
     * @return
     */
    public function index() {
        ...
        $this->load->language('module/attributes');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            if ($this->request->hasQuery('w')) {
                ...
                $settings = new stdClass;
                $settings->route = 'module/attributes';
                $settings->autoload = 1;
            ...
            $this->template = 'module/attributes/widget.tpl';
