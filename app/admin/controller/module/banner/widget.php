 ...
 * @see Controller
 */
class ControllerModuleBannerWidget extends Controller {

    private $error = array();
    private $module = 'banner';

    /**
     * ControllerModuleBannerWidget::index()
     * 
     * @return
     */
    public function index() {
        ...
        $this->load->model('content/'. $this->module);
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_banner_widget')) ? $this->config->get('default_admin_view_module_banner_widget') : 'module/'. $this->module .'/widget.tpl';
