 ...
 * @see Controller
 */
class ControllerModuleCartWidget extends Controller {
	private $error = array(); 
	
	/**
	 * ControllerModuleCartWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
    		...
    		$this->template = 'module/cart/widget.tpl';
