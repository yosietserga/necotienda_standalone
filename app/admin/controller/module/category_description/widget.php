<?php
/**
 * ControllerModuleCategoryDescriptionWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCategoryDescriptionWidget extends Controller {
	private $error = array();
    private $module = 'category_description';
	
	/**
	 * ControllerModuleCategoryDescriptionWidget::index()
	 * 
	 * @return
	 */
