...
/**
 * ControllerModuleCategoryNameInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCategoryNameInstall extends Controller {

    private $error = array();
    private $module = 'category_name';

    /**
     * ControllerModuleCategoryNameInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleCategoryNameInstall::validate()
     * 
     * @return
     */
