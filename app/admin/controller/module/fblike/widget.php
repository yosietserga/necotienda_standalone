 ...
 * @see Controller
 */
class ControllerModuleFBLikeWidget extends Controller {
	private $error = array(); 
	
	/**
	 * ControllerModuleFBLikeWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
    		...
    		$this->template = 'module/fblike/widget.tpl';
