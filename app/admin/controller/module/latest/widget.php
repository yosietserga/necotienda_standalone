 ...
 * @see Controller
 */
class ControllerModuleLatestWidget extends Controller {
	private $error = array(); 
	
	/**
	 * ControllerModuleLatestWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
    		...
    		$this->template = 'module/latest/widget.tpl';
