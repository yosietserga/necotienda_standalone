<?php
/**
 * ControllerModuleLightboxWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleLightboxWidget extends Controller {
	private $error = array();
    private $module = 'lightbox';
	
	/**
	 * ControllerModuleLightboxWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_lightbox_widget')) ? $this->config->get('default_admin_view_module_lightbox_widget') : 'module/'. $this->module .'/widget.tpl';
