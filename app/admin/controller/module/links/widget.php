 ...
 * @see Controller
 */
class ControllerModuleLinksWidget extends Controller {
	private $error = array();
    private $module = 'links';
	
	/**
	 * ControllerModuleLinksWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_links_widget')) ? $this->config->get('default_admin_view_module_links_widget') : 'module/'. $this->module .'/widget.tpl';
