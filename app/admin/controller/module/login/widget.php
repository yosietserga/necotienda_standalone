 ...
 * @see Controller
 */
class ControllerModuleLoginWidget extends Controller {
	private $error = array(); 
	
	/**
	 * ControllerModuleLoginWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
    		...
    		$this->template = 'module/login/widget.tpl';
