    ...
    <div class="grid_12">
        <div class="box">
            <div class="header">
                ...
                <a href="<?php echo $Url::createAdminUrl('module/crm/status'); ?>" class="button">Principal de los Pasos</a>
                <a href="<?php echo $Url::createAdminUrl('module/crm/status/create'); ?>" class="button"><?php echo $Language->get('button_insert'); ?></a>
                </div>
            </div>    
...
<script>
$(function(){
    $('#gridWrapper').load('<?php echo $Url::createAdminUrl("module/crm/status/grid"); ?>',
    function(){
        $('#gridPreloader').hide();
    });
    ...
    $('#formFilter').ntForm({
        ...
        type:'get',
        dataType:'html',
        url:'<?php echo $Url::createAdminUrl("module/crm/status/grid"); ?>',
        beforeSend:function(){
            $('#gridWrapper').hide();
            $('#gridPreloader').show();
        },
