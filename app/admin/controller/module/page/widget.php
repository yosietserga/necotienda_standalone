 ...
 * @see Controller
 */
class ControllerModulePageWidget extends Controller {
	private $error = array(); 
	
	/**
	 * ControllerModulePageWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
    		...
    		$this->template = 'module/page/widget.tpl';
