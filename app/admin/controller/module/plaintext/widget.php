<?php
/**
 * ControllerModulePlainTextWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePlainTextWidget extends Controller {
	private $error = array();
    private $module = 'plaintext';
	
	/**
	 * ControllerModulePlainTextWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_plaintext_widget')) ? $this->config->get('default_admin_view_module_plaintext_widget') : 'module/'. $this->module .'/widget.tpl';
