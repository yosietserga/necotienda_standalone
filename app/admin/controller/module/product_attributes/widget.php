...
/**
 * ControllerModuleProductAttributesWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductAttributesWidget extends Controller {

    private $error = array();
    private $module = 'product_attributes';

    /**
     * ControllerModuleProductAttributesWidget::index()
     * 
     * @return
     */
    public function index() {
        ...
        $this->data['attributess'] = $this->modelAttribute->getAllGroups();
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            if ($this->request->hasQuery('w')) {
                ...
                $this->setvar('lading_pages', $widget_info);
            ...
            $template = ($this->config->get('default_admin_view_module_product_attributes_widget')) ? $this->config->get('default_admin_view_module_product_attributes_widget') : 'module/'. $this->module .'/widget.tpl';
