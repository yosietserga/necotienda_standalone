<?php
/**
 * ControllerModuleProductDescriptionWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductDescriptionWidget extends Controller {
	private $error = array();
    private $module = 'product_description';
	
	/**
	 * ControllerModuleProductDescriptionWidget::index()
	 * 
	 * @return
	 */
