<?php
/**
 * ControllerModuleProductImagesWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductImagesWidget extends Controller {
	private $error = array();
    private $module = 'product_images';
	
	/**
	 * ControllerModuleProductImagesWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_product_images_widget')) ? $this->config->get('default_admin_view_module_product_images_widget') : 'module/'. $this->module .'/widget.tpl';
