    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            if ($this->request->hasQuery('w')) {
                ...
                $this->data['manufacturers'] = $this->getManufacturers($m, $widget_info['name'], $this->data['settings']['manufacturers']);
            } else {
                $settings = new stdClass;
                ...
                $this->data['manufacturers'] = $this->getManufacturers($m, $data['name'], null);
            }
            ...
            $template = ($this->config->get('default_admin_view_module_product_list_widget')) ? $this->config->get('default_admin_view_module_product_list_widget') : 'module/'. $this->module .'/widget.tpl';
