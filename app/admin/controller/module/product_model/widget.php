<?php
/**
 * ControllerModuleProductModelWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductModelWidget extends Controller {
	private $error = array();
    private $module = 'product_model';
	
	/**
	 * ControllerModuleProductModelWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_product_model_widget')) ? $this->config->get('default_admin_view_module_product_model_widget') : 'module/'. $this->module .'/widget.tpl';
