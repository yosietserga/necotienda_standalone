<?php
/**
 * ControllerModuleProductNameWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductNameWidget extends Controller {
	private $error = array();
    private $module = 'product_name';
	
	/**
	 * ControllerModuleProductNameWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_product_name_widget')) ? $this->config->get('default_admin_view_module_product_name_widget') : 'module/'. $this->module .'/widget.tpl';
