...
/**
 * ControllerModuleProductStockPlugin
 * 
 * @package   
 * @author NecoTienda
 ...
 * @access public
 */
class ControllerModuleProductStockPlugin extends Controller {

    private $error = array();
    private $module = 'product_stock';

    /**
     * ControllerModuleProductStockPlugin::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleProductStockPlugin::validate()
     * 
     * @return
     */
