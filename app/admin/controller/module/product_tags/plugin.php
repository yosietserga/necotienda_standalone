...
/**
 * ControllerModuleProductTagsPlugin
 * 
 * @package   
 * @author NecoTienda
 ...
 * @access public
 */
class ControllerModuleProductTagsPlugin extends Controller {

    private $error = array();
    private $module = 'product_tags';

    /**
     * ControllerModuleProductTagsPlugin::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleProductTagsPlugin::validate()
     * 
     * @return
     */
