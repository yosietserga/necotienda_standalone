 ...
 * @see Controller
 */
class ControllerModuleReviewsWidget extends Controller {

    private $error = array();
    private $module = 'reviews';

    /**
     * ControllerModuleReviewsWidget::index()
     * 
     * @return
     */
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_reviews_widget')) ? $this->config->get('default_admin_view_module_reviews_widget') : 'module/'. $this->module .'/widget.tpl';
