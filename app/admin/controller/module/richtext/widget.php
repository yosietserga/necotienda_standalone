<?php
/**
 * ControllerModuleRichTextWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleRichTextWidget extends Controller {
	private $error = array();
    private $module = 'richtext';
	
	/**
	 * ControllerModuleRichTextWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_richtext_widget')) ? $this->config->get('default_admin_view_module_richtext_widget') : 'module/'. $this->module .'/widget.tpl';
