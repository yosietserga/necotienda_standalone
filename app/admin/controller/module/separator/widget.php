<?php
/**
 * ControllerModuleSeparatorWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleSeparatorWidget extends Controller {
	private $error = array();
    private $module = 'separator';
	
	/**
	 * ControllerModuleSeparatorWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_separator_widget')) ? $this->config->get('default_admin_view_module_separator_widget') : 'module/'. $this->module .'/widget.tpl';
