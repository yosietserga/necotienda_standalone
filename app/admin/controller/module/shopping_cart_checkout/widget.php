<?php
/**
 * ControllerModuleShoppingCartCheckoutWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleShoppingCartCheckoutWidget extends Controller {
	private $error = array();
    private $module = 'shopping_cart_checkout';
	
	/**
	 * ControllerModuleShoppingCartCheckoutWidget::index()
	 * 
	 * @return
	 */
