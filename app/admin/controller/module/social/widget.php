 ...
 * @see Controller
 */
class ControllerModuleSocialWidget extends Controller {
	private $error = array(); 
	
	/**
	 * ControllerModuleSocialWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
    		...
    		$this->template = 'module/social/widget.tpl';
