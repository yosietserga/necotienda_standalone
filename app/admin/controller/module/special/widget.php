 ...
 * @see Controller
 */
class ControllerModuleSpecialWidget extends Controller {
	private $error = array(); 
	
	/**
	 * ControllerModuleSpecialWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
    		...
    		$this->template = 'module/special/widget.tpl';
