<?php
/**
 * ControllerModuleStoreDescriptionWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleStoreDescriptionWidget extends Controller {
	private $error = array();
    private $module = 'store_description';
	
	/**
	 * ControllerModuleStoreDescriptionWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_store_description_widget')) ? $this->config->get('default_admin_view_module_store_description_widget') : 'module/'. $this->module .'/widget.tpl';
