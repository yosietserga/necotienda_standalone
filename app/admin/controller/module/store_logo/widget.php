<?php
/**
 * ControllerModuleStoreLogoWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleStoreLogoWidget extends Controller {
	private $error = array();
    private $module = 'store_logo';
	
	/**
	 * ControllerModuleStoreLogoWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_store_logo_widget')) ? $this->config->get('default_admin_view_module_store_logo_widget') : 'module/'. $this->module .'/widget.tpl';
