<?php
/**
 * ControllerModuleStoreTitleWidget
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleStorePhoneWidget extends Controller {
	private $error = array();
    private $module = 'store_phone';
	
	/**
	 * ControllerModuleStoreTitleWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_store_phone_widget')) ? $this->config->get('default_admin_view_module_store_phone_widget') : 'module/'. $this->module .'/widget.tpl';
