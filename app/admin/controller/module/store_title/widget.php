 ...
 * @see Controller
 */
class ControllerModuleStoreTitleWidget extends Controller {
	private $error = array();
	...
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
            ...
            $template = ($this->config->get('default_admin_view_module_store_title_widget')) ? $this->config->get('default_admin_view_module_store_title_widget') : 'module/'. $this->module .'/widget.tpl';
