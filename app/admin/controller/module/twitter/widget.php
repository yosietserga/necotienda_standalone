 ...
 * @see Controller
 */
class ControllerModuleTwitterWidget extends Controller {
	private $error = array(); 
	
	/**
	 * ControllerModuleTwitterWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
    		...
    		$this->template = 'module/twitter/widget.tpl';
