...
class ControllerPaymentBankTransfer extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
			...
			$this->modelSetting->editSetting('bank_transfer', $this->request->post);				
		...
		$languages = $this->modelLanguage->getLanguages();
		...
		$this->data['geo_zones'] = $this->modelGeozone->getGeoZones();
