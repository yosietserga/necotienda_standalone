...
class ControllerReportSale extends Controller { 
	public function index() { 
		$this->document->title = $this->data['heading_title'] = $this->language->get('heading_title');
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => Url::createAdminUrl('report/sale') . $url,
        ...
        $scripts[] = array('id'=>'sortable','method'=>'ready','script'=>
            "$('#gridWrapper').load('". Url::createAdminUrl("report/sale/grid") ."',function(){
                $('#gridPreloader').hide();
            });
            ...
            $('#formFilter').ntForm({
                ...
                type:'get',
                dataType:'html',
                url:'". Url::createAdminUrl("report/sale/grid") ."',
                beforeSend:function(){
                    $('#gridWrapper').hide();
                    $('#gridPreloader').show();
                },
	...
	public function grid() {  
		...
		$order_total = $this->modelSale->getSaleReportTotal($data);
		
		$results = $this->modelSale->getSaleReport($data);
		...
		$this->template = 'report/sale_grid.tpl';
		$this->response->setOutput($this->render(true), $this->config->get('config_compression'));
	}
}
