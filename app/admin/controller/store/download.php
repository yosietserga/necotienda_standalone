...
class ControllerStoreDownload extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_store_download_list')) ? $this->config->get('default_admin_view_store_download_list') : 'store/download_list.tpl';
    ...
    public function grid() {
        ...
        $template = ($this->config->get('default_admin_view_store_download_grid')) ? $this->config->get('default_admin_view_store_download_grid') : 'store/download_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        if (isset($this->request->get['download_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $download_info = $this->modelDownload->getById($this->request->get['download_id']);
        }
        ...
        $template = ($this->config->get('default_admin_view_store_download_form')) ? $this->config->get('default_admin_view_store_download_form') : 'store/download_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
