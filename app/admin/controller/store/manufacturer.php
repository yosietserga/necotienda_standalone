...
class ControllerStoreManufacturer extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_store_manufacturer_list')) ? $this->config->get('default_admin_view_store_manufacturer_list') : 'store/manufacturer_list.tpl';
    ...
    public function grid() {
        ...
        $template = ($this->config->get('default_admin_view_store_manufacturer_grid')) ? $this->config->get('default_admin_view_store_manufacturer_grid') : 'store/manufacturer_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        $template = ($this->config->get('default_admin_view_store_manufacturer_form')) ? $this->config->get('default_admin_view_store_manufacturer_form') : 'store/manufacturer_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
