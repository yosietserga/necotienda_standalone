...
class ControllerStoreStore extends Controller {
    ...
    private function getForm() {
        ...
        $this->setVarData('config_rif', $store_info, $this->config->get('config_rif'));
        $this->setVarData('config_url', $store_info, $this->config->get('config_url'));
        $this->setVarData('config_owner', $store_info, $this->config->get('config_owner'));
        $this->setVarData('config_address', $store_info, $this->config->get('config_address'));
        $this->setVarData('config_email', $store_info, $this->config->get('config_email'));
        $this->setVarData('config_telephone', $store_info, $this->config->get('config_telephone'));
        $this->setVarData('config_fax', $store_info, $this->config->get('config_fax'));
        $this->setVarData('config_title', $store_info, $this->config->get('config_title'));
        $this->setVarData('config_meta_description', $store_info, $this->config->get('config_meta_description'));
        $this->setVarData('config_template', $store_info, $this->config->get('config_template'));
        $this->setVarData('config_mobile_template', $store_info, $this->config->get('config_mobile_template'));
        $this->setVarData('config_tablet_template', $store_info, $this->config->get('config_tablet_template'));
        $this->setVarData('config_facebook_template', $store_info, $this->config->get('config_facebook_template'));
        ...
        $this->setVarData('config_redirect_when_mobile', $store_info, $this->config->get('config_redirect_when_mobile'));
        $this->setVarData('config_redirect_when_tablet', $store_info, $this->config->get('config_redirect_when_tablet'));
        $this->setVarData('config_redirect_when_facebook', $store_info, $this->config->get('config_redirect_when_facebook'));
        $this->setVarData('config_country_id', $store_info, $this->config->get('config_country_id'));
        $this->setVarData('config_zone_id', $store_info, $this->config->get('config_zone_id'));
        $this->setVarData('config_language', $store_info, $this->config->get('config_language'));
        $this->setVarData('config_admin_language', $store_info, $this->config->get('config_admin_language'));
        $this->setVarData('config_currency', $store_info, $this->config->get('config_currency'));
        $this->setVarData('config_currency_auto', $store_info, $this->config->get('config_currency_auto'));
        $this->setVarData('config_tax', $store_info, $this->config->get('config_tax'));
        $this->setVarData('config_customer_group_id', $store_info, $this->config->get('config_customer_group_id'));
        $this->setVarData('config_customer_price', $store_info, $this->config->get('config_customer_price'));
        $this->setVarData('config_customer_approval', $store_info, $this->config->get('config_customer_approval'));
        $this->setVarData('config_store_mode', $store_info, $this->config->get('config_store_mode'));
        $this->setVarData('config_account_id', $store_info, $this->config->get('config_account_id'));
        $this->setVarData('config_checkout_id', $store_info, $this->config->get('config_checkout_id'));
        $this->setVarData('config_stock_display', $store_info, $this->config->get('config_stock_display'));
        $this->setVarData('config_stock_checkout', $store_info, $this->config->get('config_stock_checkout'));
        $this->setVarData('config_order_status_id', $store_info, $this->config->get('config_order_status_id'));
        $this->setVarData('config_stock_status_id', $store_info, $this->config->get('config_stock_status_id'));
        $this->setVarData('config_shipping_session', $store_info, $this->config->get('config_shipping_session'));
        $this->setVarData('config_admin_limit', $store_info, $this->config->get('config_admin_limit'));
        $this->setVarData('config_catalog_limit', $store_info, $this->config->get('config_catalog_limit'));
        $this->setVarData('config_new_days', $store_info, $this->config->get('config_new_days'));
        $this->setVarData('config_cart_weight', $store_info, $this->config->get('config_cart_weight'));
        $this->setVarData('config_review', $store_info, $this->config->get('config_review'));
        $this->setVarData('config_review_approve', $store_info, $this->config->get('config_review_approve'));
        $this->setVarData('config_logo', $store_info, $this->config->get('config_logo'));
        $this->setVarData('config_email_logo', $store_info, $this->config->get('config_email_logo'));
        $this->setVarData('config_mobile_logo', $store_info, $this->config->get('config_mobile_logo'));
        $this->setVarData('config_icon', $store_info, $this->config->get('config_icon'));
        $this->setVarData('config_image_thumb_width', $store_info, $this->config->get('config_image_thumb_width'));
        $this->setVarData('config_image_thumb_height', $store_info, $this->config->get('config_image_thumb_height'));
        $this->setVarData('config_image_popup_width', $store_info, $this->config->get('config_image_popup_width'));
        $this->setVarData('config_image_popup_height', $store_info, $this->config->get('config_image_popup_height'));
        $this->setVarData('config_image_category_width', $store_info, $this->config->get('config_image_category_width'));
        $this->setVarData('config_image_category_height', $store_info, $this->config->get('config_image_category_height'));
        $this->setVarData('config_image_post_width', $store_info, $this->config->get('config_image_post_width'));
        $this->setVarData('config_image_post_height', $store_info, $this->config->get('config_image_post_height'));
        $this->setVarData('config_image_product_width', $store_info, $this->config->get('config_image_product_width'));
        $this->setVarData('config_image_product_height', $store_info, $this->config->get('config_image_product_height'));
        $this->setVarData('config_image_additional_width', $store_info, $this->config->get('config_image_additional_width'));
        $this->setVarData('config_image_additional_height', $store_info, $this->config->get('config_image_additional_height'));
        $this->setVarData('config_image_related_width', $store_info, $this->config->get('config_image_related_width'));
        $this->setVarData('config_image_related_height', $store_info, $this->config->get('config_image_related_height'));
        $this->setVarData('config_image_cart_width', $store_info, $this->config->get('config_image_cart_width'));
        $this->setVarData('config_image_cart_height', $store_info, $this->config->get('config_image_cart_height'));
        $this->setVarData('config_mail_protocol', $store_info, $this->config->get('config_mail_protocol'));
        $this->setVarData('config_smtp_host', $store_info, $this->config->get('config_smtp_host'));
        $this->setVarData('config_pop3_host', $store_info, $this->config->get('config_pop3_host'));
        $this->setVarData('config_smtp_from_email', $store_info, $this->config->get('config_smtp_from_email'));
        $this->setVarData('config_smtp_from_name', $store_info, $this->config->get('config_smtp_from_name'));
        $this->setVarData('config_smtp_username', $store_info, $this->config->get('config_smtp_username'));
        $this->setVarData('config_smtp_password', $store_info,$this->config->get('config_smtp_password'));
        ...
        $this->setVarData('config_seo_url', $store_info, $this->config->get('config_seo_url'));
        $this->setVarData('config_compression', $store_info, $this->config->get('config_compression'));
