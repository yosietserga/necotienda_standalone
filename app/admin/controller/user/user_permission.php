...
class ControllerUserUserPermission extends Controller {
    ...
    private function getList() {
        ...
        $template = ($this->config->get('default_admin_view_user_user_group_list')) ? $this->config->get('default_admin_view_user_user_group_list') : 'user/user_group_list.tpl';
    ...
    public function grid() {
        ...
        $template = ($this->config->get('default_admin_view_user_user_group_grid')) ? $this->config->get('default_admin_view_user_user_group_grid') : 'user/user_group_grid.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
    ...
    private function getForm() {
        ...
        $template = ($this->config->get('default_admin_view_user_user_group_form')) ? $this->config->get('default_admin_view_user_user_group_form') : 'user/user_group_form.tpl';
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_admin_template') . '/'. $template)) {
            $this->template = $this->config->get('config_admin_template') . '/' . $template;
        } else {
            $this->template = 'default/' . $template;
