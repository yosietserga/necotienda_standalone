...
<div class="container">
    ...
    <div class="box">
        <div class="heading">
            ...
            <div class="buttons"><a title="" onClick="location = '<?php echo $Url::createAdminUrl('cpanel/email/insert'); ?>'" class="button"><span><?php echo $Language->get('button_insert'); ?></span></a><a title="" onClick="$('#form').attr('action', '<?php echo $delete; ?>'); $('#form').submit();" class="button"><span><?php echo $Language->get('button_delete'); ?></span></a></div>
        </div>
        <div class="content">
