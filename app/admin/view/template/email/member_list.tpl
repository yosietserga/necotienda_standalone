      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="left"><?php if ($sort == 'email') { ?>
              ...
              <?php } ?></td>          
            <td class="left"><?php if ($sort == 'newsletter') { ?>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="left"><?php echo $member['newsletter']; ?></td>
            <td class="left"><?php echo $member['total']; ?></td>
...
<form action="index.php?route=tool/vcard&token=<?php echo $_GET['token']; ?>" name="vcard_form" id="vcard_form" method="post">
...
<script type="text/javascript">
function filter() {
	url = 'index.php?route=email/member&token=<?php echo $token; ?>';
