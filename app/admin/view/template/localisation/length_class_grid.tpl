    ...
    <table id="list">
        <thead>
            <tr>
                ...
                <th><a onclick="$('#gridWrapper').load('<?php echo $sort_unit; ?>')"<?php if ($sort == 'unit') { ?> class="<?php echo strtolower($order); ?>" <?php } ?>><?php echo $Language->get('column_unit'); ?></a></th>
        ...
        <?php if ($length_classes) { ?>
            ...
            <tr id="tr_<?php echo $length_class['length_class_id']; ?>">
                <td><input title="Seleccionar para una acci&oacute;n" type="checkbox" name="selected[]" value="<?php echo $length_class['length_class_id']; ?>" <?php if ($length_class['selected']) { ?>checked="checked"<?php } ?>/></td>
                ...
                <?php 
                    if ($action['action'] == "activate") { 
                        $jsfunction = "activate(". $length_class['length_class_id'] .")";
                        $href = "";
                    } elseif ($action['action'] == "delete") {
                        $jsfunction = "eliminar(". $length_class['length_class_id'] .")";
                        $href = "";
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $length_class['length_class_id']; ?>" src="image/<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
