...
<form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
    <table id="list">
        ...
        <?php if ($tax_classes) { ?>
            ...
            <tr id="tr_<?php echo $tax_class['tax_class_id']; ?>">
                <td><input title="Seleccionar para una acci&oacute;n" type="checkbox" name="selected[]" value="<?php echo $tax_class['tax_class_id']; ?>" <?php if ($tax_class['selected']) { ?>checked="checked"<?php } ?>/></td>
                <td><?php echo $tax_class['title']; ?></td>
                <td>
                <?php foreach ($tax_class['action'] as $action) { ?>
                <?php 
                    if ($action['action'] == "activate") { 
                        $jsfunction = "activate(". $tax_class['tax_class_id'] .")";
                        $href = "";
                    } elseif ($action['action'] == "delete") {
                        $jsfunction = "eliminar(". $tax_class['tax_class_id'] .")";
                        $href = "";
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $tax_class['tax_class_id']; ?>" src="image/<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
