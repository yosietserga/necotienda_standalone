...
<div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                <label><?php echo $entry_contact; ?></label>
                <?php if ($contacts) { ?>
                ...
                <?php foreach ($contacts as $contact) { ?>
                    <li>
                        <input title="<?php echo $help_contact; ?>" type="checkbox" name="contact_list[]" value="<?php echo $contact['contact_id']; ?>"<?php if (in_array($contact['contact_id'], $contacts_list)) { ?> checked="checked"<?php } ?> showquick="off" />
