    ...
    <table id="list">
        <thead>
            <tr>
                ...
                <th><a onclick="$('#gridWrapper').load('<?php echo $sort_contacts; ?>')"<?php if ($sort == 'contacts') { ?> class="<?php echo strtolower($order); ?>" <?php } ?>><?php echo $column_contacts; ?></a></th>
        ...
        <?php if ($lists) { ?>
            ...
            <?php } ?>
        <?php } else { ?>
            <tr><td colspan="5" style="text-align:center"><?php echo $text_no_results; ?></td></tr>
        <?php } ?>
        </tbody>
    </table>
</form>
