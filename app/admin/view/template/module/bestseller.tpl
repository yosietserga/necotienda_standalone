    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><input title="<?php echo $help_limit; ?>" type="number" name="bestseller_limit" value="<?php echo $bestseller_limit; ?>"></td>
        </tr>
        <tr>
          <td><?php echo $entry_position; ?><a title="<?php echo $help_position; ?>"> (?)</a></td>
          <td><select title="<?php echo $help_position; ?>" name="bestseller_position">
        ...
        <tr>
          ...
          <td><input title="<?php echo $help_sort_order; ?>" type="number" name="bestseller_sort_order" value="<?php echo $bestseller_sort_order; ?>"></td>
        </tr>
      </table>
    </form>
  </div>
