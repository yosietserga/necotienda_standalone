    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><select title="<?php echo $help_position; ?>" name="category_position">
        ...
        <tr>
          ...
          <td><select title="<?php echo $help_status; ?>">
        ...
        <tr>
          ...
          <td><input title="<?php echo $help_sort_order; ?>" type="number" name="category_sort_order" value="<?php echo $category_sort_order; ?>"></td>
        </tr>
      </table>
    </form>
  </div>
