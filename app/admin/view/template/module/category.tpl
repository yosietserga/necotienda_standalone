...
<div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_position; ?>" name="category_position">
                    <?php foreach ($positions as $position) { ?>
                    <option value="<?php echo $position['position']; ?>"<?php if ($category_position == $position['position']) { ?> selected="selected"<?php } ?>><?php echo $position['title']; ?></option>
                  <?php } ?>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $help_sort_order; ?>" type="number" name="category_sort_order" value="<?php echo $category_sort_order; ?>" style="width: 40px;" />
            </div>
