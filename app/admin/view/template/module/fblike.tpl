...
<div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                <label><?php echo $entry_pageid; ?></label>
                <input title="<?php echo $help_pageid; ?>" type="text" name="fblike_pageid" value="<?php echo $fblike_pageid; ?>" />
            </div>
                  
            <div class="clear"></div>
            
            <div class="row">
                <label><?php echo $entry_totalconnection; ?></label>
                <input title="<?php echo $help_totalconnection; ?>" type="number" name="fblike_totalconnection" value="<?php echo $fblike_totalconnection; ?>" style="width: 40px;" />
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $help_width; ?>" type="number" name="fblike_width" value="<?php echo $fblike_width; ?>" style="width: 40px;" />
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $help_height; ?>" type="number" name="fblike_height" value="<?php echo $fblike_height; ?>" style="width: 40px;" />
            </div>
                  
            <div class="clear"></div>
            
            <div class="row">
                <label><?php echo $entry_stream; ?></label>
                <select name="fblike_stream">
                    <option value="1"<?php if ($fblike_stream) { ?> selected="selected"<?php } ?>><?php echo $text_true; ?></option>
                    <option value="0"<?php if ($fblike_stream) { ?> selected="selected"<?php } ?>><?php echo $text_false; ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <select name="fblike_header">
                    <option value="1"<?php if ($fblike_header) { ?> selected="selected"<?php } ?>><?php echo $text_true; ?></option>
                    <option value="0"<?php if ($fblike_header) { ?> selected="selected"<?php } ?>><?php echo $text_false; ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_position; ?>" name="fblike_position">
                    <?php foreach ($positions as $position) { ?>
                    <option value="<?php echo $position['position']; ?>"<?php if ($fblike_position == $position['position']) { ?> selected="selected"<?php } ?>><?php echo $position['title']; ?></option>
                  <?php } ?>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_status; ?>" name="fblike_status">
                    <option value="1"<?php if ($fblike_status) { ?> selected="selected"<?php } ?>><?php echo $text_enabled; ?></option>
                    <option value="0"<?php if (!$fblike_status) { ?> selected="selected"<?php } ?>><?php echo $text_disabled; ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $help_sort_order; ?>" type="number" name="fblike_sort_order" value="<?php echo $fblike_sort_order; ?>" style="width: 40px;" />
            </div>
