    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
          ...
          <td><input title="<?php echo $help_limit; ?>" type="number" name="featured_limit" value="<?php echo $featured_limit; ?>"></td>
        </tr>
        <tr>
          <td><?php echo $entry_position; ?><a title="<?php echo $help_position; ?>"> (?)</a></td>
          <td><select title="<?php echo $help_position; ?>" name="featured_position">
        ...
        <tr>
          ...
          <td><select title="<?php echo $help_status; ?>" name="featured_status">
        ...
        <tr>
          ...
          <td><input title="<?php echo $help_sort_order; ?>" type="number" name="featured_sort_order" value="<?php echo $featured_sort_order; ?>"></td>
        </tr>
		<tr>
