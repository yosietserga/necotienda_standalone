...
<div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                ...
                <input title="<?php echo $help_limit; ?>" type="number" name="featured_limit" value="<?php echo $featured_limit; ?>" style="width: 40px;" />
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_position; ?>" name="featured_position">
                    <?php foreach ($positions as $position) { ?>
                    <option value="<?php echo $position['position']; ?>"<?php if ($featured_position == $position['position']) { ?> selected="selected"<?php } ?>><?php echo $position['title']; ?></option>
                  <?php } ?>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_status; ?>" name="featured_status">
                    <option value="1"<?php if ($featured_status) { ?> selected="selected"<?php } ?>><?php echo $text_enabled; ?></option>
                    <option value="0"<?php if (!$featured_status) { ?> selected="selected"<?php } ?>><?php echo $text_disabled; ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $help_sort_order; ?>" type="number" name="featured_sort_order" value="<?php echo $featured_sort_order; ?>" style="width: 40px;" />
            </div>
