...
<div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                ...
                <textarea name="google_maps_code" cols="70" rows="7" style="width: 40%;"><?php echo $google_maps_code; ?></textarea>
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_status; ?>" name="google_maps_status">
                    <option value="1"<?php if ($google_maps_status) { ?> selected="selected"<?php } ?>><?php echo $text_enabled; ?></option>
                    <option value="0"<?php if (!$google_maps_status) { ?> selected="selected"<?php } ?>><?php echo $text_disabled; ?></option>
                </select>
            </div>
