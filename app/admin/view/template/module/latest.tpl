...
<div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                ...
                <input title="<?php echo $help_limit; ?>" type="number" name="latest_limit" value="<?php echo $latest_limit; ?>" style="width: 40px;" />
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_position; ?>" name="latest_position">
                    <?php foreach ($positions as $position) { ?>
                    <option value="<?php echo $position['position']; ?>"<?php if ($latest_position == $position['position']) { ?> selected="selected"<?php } ?>><?php echo $position['title']; ?></option>
                  <?php } ?>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_status; ?>" name="latest_status">
                    <option value="1"<?php if ($latest_status) { ?> selected="selected"<?php } ?>><?php echo $text_enabled; ?></option>
                    <option value="0"<?php if (!$latest_status) { ?> selected="selected"<?php } ?>><?php echo $text_disabled; ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $help_sort_order; ?>" type="number" name="latest_sort_order" value="<?php echo $latest_sort_order; ?>" style="width: 40px;" />
            </div>
