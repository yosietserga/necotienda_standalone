                ...
                <div class="grid_24">
                    <div class="box">
                        ...
                        <div class="row">
                            ...
                            <input name="layer_slider_facebook_app_id" value="<?php echo isset($layer_slider_facebook_app_id) ? $layer_slider_facebook_app_id : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>Facebook App Secret</label>
                            <input name="layer_slider_facebook_app_secret" value="<?php echo isset($layer_slider_facebook_app_secret) ? $layer_slider_facebook_app_secret : ''; ?>" style="width:40%" />
                        </div>
                ...
                <div class="grid_24">
                    <div class="box">
                        ...
                        <div class="row">
                            ...
                            <input name="layer_slider_twitter_consumer_key" value="<?php echo isset($layer_slider_twitter_consumer_key) ? $layer_slider_twitter_consumer_key : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>Twitter Consumer Secret</label>
                            <input name="layer_slider_twitter_consumer_secret" value="<?php echo isset($layer_slider_twitter_consumer_secret) ? $layer_slider_twitter_consumer_secret : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>Twitter Access Token</label>
                            <input name="layer_slider_twitter_oauth_token" value="<?php echo isset($layer_slider_twitter_oauth_token) ? $layer_slider_twitter_oauth_token : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>Twitter Access Token Secret</label>
                            <input name="layer_slider_twitter_oauth_token_secret" value="<?php echo isset($layer_slider_twitter_oauth_token_secret) ? $layer_slider_twitter_oauth_token_secret : ''; ?>" style="width:40%" />
                        </div>
                ...
                <div class="grid_24">
                    <div class="box">
                        ...
                        <div class="row">
                            ...
                            <input name="layer_slider_google_client_id" value="<?php echo isset($layer_slider_google_client_id) ? $layer_slider_google_client_id : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>Google Client Secret</label>
                            <input name="layer_slider_google_client_secret" value="<?php echo isset($layer_slider_google_client_secret) ? $layer_slider_google_client_secret : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>Google API Key</label>
                            <input name="layer_slider_google_api_key" value="<?php echo isset($layer_slider_google_api_key) ? $layer_slider_google_api_key : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>Google Consumer Key</label>
                            <input name="layer_slider_google_consumer_key" value="<?php echo isset($layer_slider_google_consumer_key) ? $layer_slider_google_consumer_key : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>Google Consumer Secret</label>
                            <input name="layer_slider_google_consumer_secret" value="<?php echo isset($layer_slider_google_consumer_secret) ? $layer_slider_google_consumer_secret : ''; ?>" style="width:40%" />
                        </div>
                ...
                <div class="grid_24">
                    <div class="box">
                        ...
                        <div class="row">
                            ...
                            <input name="layer_slider_live_client_id" value="<?php echo isset($layer_slider_live_client_id) ? $layer_slider_live_client_id : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>Live Client Secret</label>
                            <input name="layer_slider_live_client_secret" value="<?php echo isset($layer_slider_live_client_secret) ? $layer_slider_live_client_secret : ''; ?>" style="width:40%" />
                        </div>
                ...
                <div class="grid_24">
                    <div class="box">
                        ...
                        <div class="row">
                            ...
                            <input name="layer_slider_meli_app_id" value="<?php echo isset($layer_slider_meli_app_id) ? $layer_slider_meli_app_id : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>MercadoLibre App Secret</label>
                            <input name="layer_slider_meli_app_secret" value="<?php echo isset($layer_slider_meli_app_secret) ? $layer_slider_meli_app_secret : ''; ?>" style="width:40%" />
                        </div>
                ...
                <div class="grid_24">
                    <div class="box">
                        ...
                        <div class="row">
                            ...
                            <input name="layer_slider_paypal_app_id" value="<?php echo isset($layer_slider_paypal_app_id) ? $layer_slider_paypal_app_id : ''; ?>" style="width:40%" />
                        </div>
                        
                        <div class="row">
                            <label>PayPal App Secret</label>
                            <input name="layer_slider_paypal_app_secret" value="<?php echo isset($layer_slider_paypal_app_secret) ? $layer_slider_paypal_app_secret : ''; ?>" style="width:40%" />
                        </div>
