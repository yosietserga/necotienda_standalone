<form id="<?php echo $name; ?>_form">
    ...
    <div class="row">
        ...
        <input type="text" name="Widgets[<?php echo $name; ?>][settings][height]" value="<?php echo isset($settings['title']) ? $settings['title'] : '300px'; ?>" />
    </div>
    ...
    <input type="hidden" name="Widgets[<?php echo $name; ?>][settings][route]" value="module/lightbox" />
</form>
<script>
$(function(){
