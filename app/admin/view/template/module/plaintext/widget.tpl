<form id="<?php echo $name; ?>_form">
    ...
    <div class="row">
        <textarea name="Widgets[<?php echo $name; ?>][settings][text]" showquick="off" placeholder="<?php echo $Language->get('entry_text'); ?>" style="width:90%"><?php echo isset($settings['text']) ? $settings['text'] : ""; ?></textarea>
    </div>
    ...
    <input type="hidden" name="Widgets[<?php echo $name; ?>][settings][route]" value="module/plaintext" />
</form>