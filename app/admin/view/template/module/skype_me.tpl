...
<div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                ...
                <textarea name="skype_me_code" cols="70" rows="7" style="width: 40%;"><?php echo $skype_me_code; ?></textarea>
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_position; ?>" name="skype_me_position">
                    <?php foreach ($positions as $position) { ?>
                    <option value="<?php echo $position['position']; ?>"<?php if ($skype_me_position == $position['position']) { ?> selected="selected"<?php } ?>><?php echo $position['title']; ?></option>
                  <?php } ?>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_status; ?>" name="skype_me_status">
                    <option value="1"<?php if ($skype_me_status) { ?> selected="selected"<?php } ?>><?php echo $text_enabled; ?></option>
                    <option value="0"<?php if (!$skype_me_status) { ?> selected="selected"<?php } ?>><?php echo $text_disabled; ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $help_sort_order; ?>" type="number" name="skype_me_sort_order" value="<?php echo $skype_me_sort_order; ?>" style="width: 40px;" />
            </div>
