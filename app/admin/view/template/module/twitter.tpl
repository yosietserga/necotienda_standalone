...
<div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                <label><?php echo $entry_twitter_search; ?></label>
                <input title="<?php echo $help_twitter_search; ?>" name="twitter_search" type="text" size="20" required="required" value="<?php echo $twitter_search ?>" />
            </div>
                   
            <div class="clear"></div>
                        
            <div class="row">
                <label><?php echo $entry_twitter_time; ?></label>
                <input title="<?php echo $help_twitter_time; ?>" name="twitter_time" type="text" size="20" required="required" value="<?php echo $twitter_search ?>" />
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_position; ?>" name="twitter_position">
                    <?php foreach ($positions as $position) { ?>
                    <option value="<?php echo $position['position']; ?>"<?php if ($twitter_position == $position['position']) { ?> selected="selected"<?php } ?>><?php echo $position['title']; ?></option>
                  <?php } ?>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $help_status; ?>" name="twitter_status">
                    <option value="1"<?php if ($twitter_status) { ?> selected="selected"<?php } ?>><?php echo $text_enabled; ?></option>
                    <option value="0"<?php if (!$twitter_status) { ?> selected="selected"<?php } ?>><?php echo $text_disabled; ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $help_sort_order; ?>" type="number" name="twitter_sort_order" value="<?php echo $twitter_sort_order; ?>" style="width: 40px;" />
            </div>
