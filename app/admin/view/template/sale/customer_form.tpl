...
<div class="box">
    ...
    <ul id="vtabs" class="vtabs">
        <li><a data-target="#tab_general" onclick="showTab(this)"><?php echo $tab_general; ?></a></li>
        ...
        <li><a data-target="#tab_address_<?php echo $address_row; ?>" id="address_<?php echo $address_row; ?>" onclick="showTab(this)"><?php echo $tab_address . ' ' . $address_row; ?>
