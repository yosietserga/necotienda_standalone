...
<div class="box">
    ...
    <ul id="vtabs" class="vtabs">
        <li><a data-target="#tab_order" onclick="showTab(this)"><?php echo $tab_order; ?></a></li>
        <li><a data-target="#tab_product" onclick="showTab(this)"><?php echo $tab_product; ?></a></li>
        <li><a data-target="#tab_shipping" onclick="showTab(this)"><?php echo $tab_shipping; ?></a></li>
        <li><a data-target="#tab_payment" onclick="showTab(this)"><?php echo $tab_payment; ?></a></li>
        <li><a data-target="#tab_history" onclick="showTab(this)"><?php echo $tab_history; ?></a></li>
    </ul>
