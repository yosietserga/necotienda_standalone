...
<table class="form">
	...
	<tr>
        ...
        <?php if ($invoice_id) { ?>
            <?php echo $invoice_id; ?>
        <?php } else { ?>
            <a id="generate_button" class="button" title="Genera Factura. Para poder ver e imprimir la factura, haga clic en el bot&oacute;n Pedido"><?php echo $button_generate; ?></a>
        <?php } ?>
        </td>
	</tr>
	<tr>
