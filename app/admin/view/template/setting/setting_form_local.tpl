<div>
    ...
    <div class="row">
        <label><?php echo $entry_decimal_separator; ?></label>
        <input type="text" title="<?php echo $help_decimal_separator; ?>" name="config_decimal_separator" value="<?php echo $config_decimal_separator; ?>" />
    </div>
                                     
    <div class="clear"></div>
    
    <div class="row">
        <label><?php echo $entry_thousands_separator; ?></label>
        <input type="text" title="<?php echo $help_thousands_separator; ?>" name="config_thousands_separator" value="<?php echo $config_thousands_separator; ?>" />
    </div>
                                     
    <div class="clear"></div>
    
    <div class="row">
        <label><?php echo $entry_currency_auto; ?></label>
