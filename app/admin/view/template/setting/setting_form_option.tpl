<div>
    ...
    <table class="form">
        <tr>
            ...
            <td><input title="Ingrese la cantidad de items por p&aacute;gina que se mostrar&aacute;n en los diversos listados de la administraci&oacute;n" type="number" name="config_admin_limit" value="<?php echo $config_admin_limit; ?>" size="3">
              <?php if ($error_admin_limit) { ?>
              <span class="error"><?php echo $error_admin_limit; ?></span>
              <?php } ?></td>
          </tr>
		  <tr>
            <td><?php echo $entry_catalog_limit; ?></td>
            <td><input title="Ingrese la cantidad de items por p&aacute;gina que se mostrar&aacute;n en los diversos listados de la tienda" type="number" name="config_catalog_limit" value="<?php echo $config_catalog_limit; ?>" size="3">
          ...
          <tr>
            <td><?php echo $entry_customer_group; ?><br><span class="help">Grupo de Clientes por defecto.</span></td>
          ...
          <tr>
            <td><?php echo $entry_customer_price; ?><br><span class="help">S&oacute;lo muestra precios cuando un cliente se loguea.</span></td>
            <td>
          ...
          <tr>
            <td><?php echo $entry_customer_approval; ?><br><span class="help">No permite a un nuevo cliente loguearse hasta que su cuenta sea aprobada.</span></td>
            <td>
          ...
          <tr>
            ...
            <td>
              <input title="Seleccione si desea que los clientes puedan comprar sin registrarse previamente. Recomendamos altamente que elija la opci&oacute;n No" type="checkbox" showquick="off" name="config_guest_checkout" value="1"<?php if ($config_guest_checkout) { ?> checked="checked"<?php } ?>>
              </td>
          </tr>
          <tr>
            <td><?php echo $entry_account; ?><br><span class="help">Forza a los clientes a estar de acuerdo con los t&eacute;rminos antes de que la cuenta sea creada.</span></td>
          ...
          <tr>
            <td><?php echo $entry_checkout; ?><br><span class="help">Forza a los clientes a estar de acuerdo con los t&eacute;rminos antes de realizar una compra.</span></td>
            <td><select name="config_checkout_id" title="Seleccione los t&eacute;rminos legales que el cliente debe aceptar para completar una compra">
                <option value="0"><?php echo $text_none; ?></option>
                <?php foreach ($informations as $information) { ?>
                <option value="<?php echo $information['information_id']; ?>"<?php if ($information['information_id'] == $config_checkout_id) { ?> selected="selected"<?php } ?>><?php echo $information['title']; ?></option>
                <?php } ?>
              </select></td>
          </tr>
          <tr>
            <td><?php echo $entry_stock_display; ?><br><span class="help">Muestra el stock disponible del producto.</span></td>
            <td>
          ...
          <tr>
            <td><?php echo $entry_stock_checkout; ?><br><span class="help">Permite a los clientes comprar a&uacute;n cuando el producto est&aacute; agotado.</span></td>
            <td>
          ...
          <tr>
            <td><?php echo $entry_order_status; ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $entry_download_status; ?><br><span class="help">El cliente no puede descargar productos antes de cancelar el precio del pedido.</span></td>
