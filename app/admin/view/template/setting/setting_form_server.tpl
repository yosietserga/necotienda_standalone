<div>
    ...
    <table class="form">
        <tr>
            <td><?php echo $entry_ssl; ?><br><span class="help">Para usar SSL comprueba con tu host si hay instalado un certificado SSL y a continuaci&oacute;n añade la direcci&oacute;n del SSL en tu archivo de configuraci&oacute;n.</span></td>
            <td>
          ...
          <tr>
            <td><?php echo $entry_js_security; ?></td>
            <td>
          ...
          <tr>
            <td><?php echo $entry_server_security; ?></td>
            <td>
          ...
          <tr>
            <td><?php echo $entry_password_security; ?></td>
            <td>
          ...
          <tr>
            <td><?php echo $entry_seo_url; ?><a > [ ! ]</a><br><span class="help">Para usar el m&oacute;dulo SEO URL\ de apache  debe estar instalado el mod-rewrite y necesitas renombrar el htaccess.txt a .htaccess.</span></td>
            <td>
          ...
          <tr>
            <td><?php echo $entry_compression; ?><br><span class="help">Comprime todos los ficheros con GZIP para mejores rendimiento de la tienda. El nivel de compresi&oacute;n deber&iacute;a estar entre 0 - 9</span></td>
          ...
          <tr>
            <td><?php echo $entry_dir_export; ?></td>
