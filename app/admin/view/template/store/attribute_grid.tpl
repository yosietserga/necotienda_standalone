    ...
    <table id="list">
        ...
        <?php if ($attributes) {  foreach ($attributes as $attribute) { ?>
            <tr id="tr_<?php echo $attribute['product_attribute_group_id']; ?>">
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $attribute['product_attribute_group_id']; ?>" src="image/<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php }  } else { ?>
