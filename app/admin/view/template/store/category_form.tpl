                ...
                <?php foreach ($languages as $language) { ?>
                    <div id="language<?php echo $language['language_id']; ?>">
                        ...
                        <div class="row">
                            ...
                            <textarea title="<?php echo $help_meta_keywords; ?>" name="category_keywords[<?php echo $language['language_id']; ?>][meta_keywords]" cols="40" rows="5" style="width:40%"><?php echo isset($category_keywords[$language[ 'language_id']]) ? $category_keywords[$language[ 'language_id']][ 'meta_keywords'] : ''; ?></textarea>
                        </div>
