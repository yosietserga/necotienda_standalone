    ...
    <table class="form">
        <tr>
		  ...
		  <tr>
            ...
            <td><input class="necoNewProduct<?php if (isset($error_new_days)) echo ' neco-input-error'; ?>" title="<?php echo $Language->get('help_new_days'); ?>" type="necoNumber" name="config_new_days" value="<?php echo $config_new_days; ?>" size="3" required="true" /></td>
          </tr>
          <tr>
