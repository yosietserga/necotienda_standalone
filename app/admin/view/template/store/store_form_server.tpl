<div>
    ...
    <table class="form">
        <tr>
            <td><?php echo $Language->get('entry_ssl'); ?><br><span class="help">Para usar SSL comprueba con tu host si hay instalado un certificado SSL y a continuaci&oacute;n añade la direcci&oacute;n del SSL en tu archivo de configuraci&oacute;n.</span></td>
            <td>
