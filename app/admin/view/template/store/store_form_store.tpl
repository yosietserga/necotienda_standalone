<div>
    ...
    <div class="row">
        ...
        <select name="config_template" onchange="$('#template').load('<?php echo $Url::createAdminUrl("store/store/template"); ?>&template=' + encodeURIComponent(this.value));">
    ...
    <div id="language<?php echo $language['language_id']; ?>">
        ...
        <div class="row">
            ...
            <textarea name="config_meta_description_<?php echo $language['language_id']; ?>" cols="40" rows="5"><?php echo ${'config_meta_description_' . $language['language_id']}; ?></textarea>
        </div>
