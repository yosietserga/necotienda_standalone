    ...
    <table id="list">
        <thead>
            <tr>
                ...
                <th><a onclick="$('#gridWrapper').load('<?php echo $sort_name; ?>')"<?php if ($sort == 'name') { ?> class="<?php echo strtolower($order); ?>" <?php } ?>><?php echo $column_template; ?></a></th>
                <th><a onclick="$('#gridWrapper').load('<?php echo $sort_name; ?>')"<?php if ($sort == 'name') { ?> class="<?php echo strtolower($order); ?>" <?php } ?>><?php echo $column_date_start; ?></a></th>
            ...
            <tr id="tr_<?php echo $theme['theme_id']; ?>">
                ...
                <?php 
                    if ($action['action'] == "activate") { 
                        ...
                        $jsfunction = "eliminar(". $theme['theme_id'] .")";
                        $href = "";
                    } else {
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"<?php if (isset($action['target'])) { ?> target="<?php echo $action['target']; ?>"<?php } ?>><img id="img_<?php echo $theme['theme_id']; ?>" src="image/<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
