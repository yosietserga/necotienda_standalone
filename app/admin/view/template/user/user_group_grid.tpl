    ...
    <table id="list">
        ...
        <?php if ($user_groups) { ?>
            ...
            <tr id="tr_<?php echo $user_group['user_group_id']; ?>">
                <td><input title="Seleccionar para una acci&oacute;n" type="checkbox" name="selected[]" value="<?php echo $user_group['user_group_id']; ?>" <?php if ($user_group['selected']) { ?>checked="checked"<?php } ?>/></td>
                <td><?php echo $user_group['name']; ?></td>
                <td>
                <?php foreach ($user_group['action'] as $action) { ?>
                <?php 
                    if ($action['action'] == "delete") {
                        $jsfunction = "eliminar(". $user_group['user_group_id'] .")";
                        $href = "";
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $user_group['user_group_id']; ?>" src="image/<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
