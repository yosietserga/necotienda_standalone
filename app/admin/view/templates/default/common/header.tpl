...
<head>
    ...
    <!-- <script src="//cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.1/modernizr.min.js"></script> -->
    <!-- <script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script> -->
    <script>window.Modernizr || document.write('<script src="<?php echo str_replace('%theme%', $Config->get('config_admin_template'), HTTP_ADMIN_THEME_JS); ?>vendor/modernizr.js"><\/script>')</script>
                ...
                <div class="userNav">
                    <ul>
                        <li class="hideOnMobile">
                            <a href="<?php echo $Url::createAdminUrl("setting/cache/deletefilecache"); ?>" title="<?php echo $Language->get('text_delete_cache'); ?>">
                        ...
                        <li><a href="<?php echo $Url::createAdminUrl('common/logout'); ?>" title="<?php echo $Language->get('text_logout'); ?>">
                                <img src="<?php echo str_replace('%theme%', $Config->get('config_admin_template'), HTTP_ADMIN_THEME_IMAGE); ?>icons/topnav/logout.png" alt="<?php echo $Language->get('text_logout'); ?>" />
