    ...
    <table id="list">
        ...
        <?php if ($geo_zones) { ?>
            ...
            <tr id="tr_<?php echo $geo_zone['geo_zone_id']; ?>">
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $geo_zone['geo_zone_id']; ?>" src="<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
