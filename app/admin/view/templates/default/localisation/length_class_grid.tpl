    ...
    <table id="list">
        ...
        <?php if ($length_classes) { ?>
            ...
            <tr id="tr_<?php echo $length_class['length_class_id']; ?>">
                ...
                <td><?php echo $length_class['description']; ?></td>
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $length_class['length_class_id']; ?>" src="<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
