    ...
    <table id="list">
        ...
        <?php if ($stock_statuses) { ?>
            ...
            <tr id="tr_<?php echo $stock_status['stock_status_id']; ?>">
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $stock_status['stock_status_id']; ?>" src="<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
