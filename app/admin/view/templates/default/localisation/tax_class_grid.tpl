    ...
    <table id="list">
        ...
        <?php if ($tax_classes) { ?>
            ...
            <tr id="tr_<?php echo $tax_class['tax_class_id']; ?>">
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $tax_class['tax_class_id']; ?>" src="<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
