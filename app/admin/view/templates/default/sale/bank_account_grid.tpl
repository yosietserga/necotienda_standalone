    ...
    <table id="list">
        ...
        <?php if ($bank_accounts) { ?>
            ...
            <tr id="tr_<?php echo $bank_account['bank_account_id']; ?>">
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $bank_account['bank_account_id']; ?>" src="<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
