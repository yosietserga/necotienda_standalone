        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div id="language<?php echo $language['language_id']; ?>">
                ...
                <div class="row">
                    ...
                    <input id="coupon_description<?php echo $language['language_id']; ?>_name" name="coupon_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($coupon_description[$language['language_id']]) ? $coupon_description[$language['language_id']]['title'] : ''; ?>" required="true" title="<?php echo $Language->get('help_name'); ?>" />
                </div>
