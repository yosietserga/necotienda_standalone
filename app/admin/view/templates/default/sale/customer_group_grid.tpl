    ...
    <table id="list">
        ...
        <?php if ($customer_groups) { ?>
            ...
            <tr id="tr_<?php echo $customer_group['customer_group_id']; ?>">
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $customer_group['customer_group_id']; ?>" src="<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
