...
<table class="form">
	...
	<tr>
        ...
        <?php if ($invoice_id) { ?>
            <?php echo $invoice_id; ?>
        <?php } else { ?>
            <button id="generate_button" class="button" title="Genera Factura. Para poder ver e imprimir la factura, haga clic en el bot&oacute;n Pedido"><?php echo $Language->get('button_generate'); ?></button>
        <?php } ?>
        </td>
	</tr>
	<tr>
