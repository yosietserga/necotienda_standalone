                ...
                <?php foreach ($languages as $language) { ?>
                    <div id="language<?php echo $language['language_id']; ?>">
                        ...
                        <div class="row">
                            ...
                            <input id="download_description<?php echo $language['language_id']; ?>_name" name="download_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($download_description[$language['language_id']]) ? $download_description[$language['language_id']]['title'] : ''; ?>" required="true" style="width:40%" class="necoName" />
                        </div>
