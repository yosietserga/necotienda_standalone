    ...
    <table id="list">
        ...
        <?php if ($downloads) { ?>
            ...
            <tr id="tr_<?php echo $download['download_id']; ?>">
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $download['download_id']; ?>" src="<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
