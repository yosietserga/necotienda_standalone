<?php if ($logged) { ?><nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li><a href="<?php echo $Url::createAdminUrl('store/product'); ?>"><?php echo $Language->get('Products'); ?></a></li>
