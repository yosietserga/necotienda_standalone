        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <?php foreach ($languages as $language) { ?>
                <tr>
                  ...
                  <td><input title="Ingrese el estado del pedido. Esto es utilizado para indicar diversos estados de proceso del pedido" name="order_payment_status[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($order_payment_status[$language['language_id']]) ? $order_payment_status[$language['language_id']]['name'] : ''; ?>" required="required" style="width:40%" />
