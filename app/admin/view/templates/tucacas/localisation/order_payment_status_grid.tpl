    ...
    <table id="list">
        ...
        <?php if ($order_payment_statuses) { ?>
            ...
            <tr id="tr_<?php echo $order_payment_status['order_payment_status_id']; ?>">
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $order_payment_status['language_id']; ?>" src="image/<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
