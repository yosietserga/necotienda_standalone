    ...
    <table id="list">
        ...
        <?php if ($weight_classes) { ?>
            ...
            <tr id="tr_<?php echo $weight_class['weight_class_id']; ?>">
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $weight_class['weight_class_id']; ?>" src="image/<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td>
            </tr>
            <?php } ?>
