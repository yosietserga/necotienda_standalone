    ...
    <table id="list">
        ...
        <?php if ($payments) { ?>
            ...
            <tr id="tr_<?php echo $payment['order_payment_id']; ?>">
                ...
                ?>
                <a title="<?php echo $action['text']; ?>" <?php echo $href; ?> onclick="<?php echo $jsfunction; ?>"><img id="img_<?php echo $payment['order_payment_id']; ?>" src="image/<?php echo $action['img']; ?>" alt="<?php echo $action['text']; ?>" /></a>
                <?php } ?>
                </td> -->
            </tr>
            <?php } ?>
