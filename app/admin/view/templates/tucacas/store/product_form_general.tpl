...
<div id="language<?php echo $language['language_id']; ?>">
    ...
    <div class="row">
        ...
        <input class="necoName" id="description_<?php echo $language['language_id']; ?>_name" name="product_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" required="true" title="<?php echo $Language->get('help_name'); ?>" style="width: 40%;" />
    </div>
    ...
    <div class="row">
        ...
        <textarea class="necoKeywords" title="<?php echo $Language->get('help_meta_keywords'); ?>" name="product_description[<?php echo $language['language_id']; ?>][meta_keywords]" cols="40" rows="5" style="width: 40%;"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keywords'] : ''; ?></textarea>
    </div>
    ...
    <div class="row">
        ...
        <input class="necoKeyword" type="text" id="description_<?php echo $language['language_id']; ?>_keyword" title="<?php echo $Language->get('help_keyword'); ?>" name="product_description[<?php echo $language['language_id']; ?>][keyword]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['keyword'] : ''; ?>" />
    </div>
