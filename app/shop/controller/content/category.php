...
class ControllerContentCategory extends Controller {
	public function index() {
        ...
        //TODO: cargar la plantilla personalizada $this->setvar('template',$post_info);
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/content/category.tpl')) {
            $this->template = $this->config->get('config_template') . '/content/category.tpl';
		} else {
            $this->template = 'cuyagua/content/category.tpl';
		}
