...
class ControllerContentPage extends Controller {
		...
		if ($page_info) {
            ...
            foreach ($widgets->getWidgets('featuredContent') as $widget) {
    			...
    			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/content/page.tpl')) {
    				...
    				$this->template = 'cuyagua/content/page.tpl';
    			}
    ...
    public function all() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/content/pages.tpl')) {
            $this->template = $this->config->get('config_template') . '/content/pages.tpl';
		} else {
            $this->template = 'cuyagua/content/pages.tpl';
		}
	...
	public function review() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/content/review.tpl')) {
			$this->template = $this->config->get('config_template') . '/content/review.tpl';
		} else {
			$this->template = 'cuyagua/content/review.tpl';
		}
		$this->response->setOutput($this->render(true), $this->config->get('config_compression'));
	}
	...
	public function comment() {
	   $this->language->load('content/page');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/content/comment.tpl')) {
			$this->template = $this->config->get('config_template') . '/content/comment.tpl';
		} else {
			$this->template = 'cuyagua/content/comment.tpl';
		}
		$this->response->setOutput($this->render(true), $this->config->get('config_compression'));
	}
