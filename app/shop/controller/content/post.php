	...
	public function index() {  
        ...
        if ($post_info) {
            ...
            foreach ($widgets->getWidgets('featuredContent') as $widget) {
    			...
    			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/content/post.tpl')) {
    				$this->template = $this->config->get('config_template') . '/content/post.tpl';
    			} else {
    				$this->template = 'cuyagua/content/post.tpl';
    			}
