...
class ControllerInformationInformation extends Controller {
	public function index() {  
		...
		if ($information_info) {
      		...
      		$this->document->breadcrumbs[] = array(
        		'href'      => HTTP_HOME . 'index.php?r=information/information&information_id=' . $this->request->get['information_id'],
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/information/information.tpl')) {
				$this->template = $this->config->get('config_template') . '/information/information.tpl';
			} else {
				$this->template = 'default/information/information.tpl';
			}
