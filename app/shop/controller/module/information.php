...
class ControllerModuleInformation extends Controller {
	protected function index() {
    	...
    	$this->data['sitemap'] = HTTP_HOME . 'index.php?r=information/sitemap';
		
		$this->id = 'information';

		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/module/information.tpl')) {
			$this->template = $this->config->get('config_template') . '/module/information.tpl';
		} else {
			$this->template = 'default/module/information.tpl';
		}
