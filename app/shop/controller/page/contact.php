...
class ControllerPageContact extends Controller {
	private $error = array(); 
  	...
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/page/contact.tpl')) {
			$this->template = $this->config->get('config_template') . '/page/contact.tpl';
		} else {
			$this->template = 'cuyagua/page/contact.tpl';
		}
