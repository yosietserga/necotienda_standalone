...
class ModelCheckoutOrder extends Model {
	...
	public function confirm($order_id, $order_status_id, $comment = '') {
		...
		if ($order_query->num_rows) {
			...
			$template->data['invoice'] = $order_query->row['store_url'] . 'index.php?r=account/invoice&order_id=' . $order_id;
			...
			if ($order_query->row['customer_id']) {
				...
				$text .= $order_query->row['store_url'] . 'index.php?r=account/invoice&order_id=' . $order_id . "\n\n";
			}
		
			if ($order_download_query->num_rows) {
				$text .= $language->get('text_download') . "\n";
				$text .= $order_query->row['store_url'] . 'index.php?r=account/download' . "\n\n";
			}
