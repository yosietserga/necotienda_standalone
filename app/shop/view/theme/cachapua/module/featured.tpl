<?php if ($products) { ?>
<li class="nt-editable featured-widget<?php echo ($settings['class']) ? " ".$settings['class'] : ''; ?>" id="<?php echo $widgetName; ?>">
    ...
    <?php if ($heading_title) { ?>
        <div class="heading widget-heading heading-dropdown" id="<?php echo $widgetName; ?>Header">
            <div class="heading-title">
                <h3>
                    <i class="icon heading-icon fa fa-asterisk fa-2x"></i>
...
<!-- featured-widget-content -->
    <div class="widget-content featured-widget-content" id="<?php echo $widgetName; ?>Content">
