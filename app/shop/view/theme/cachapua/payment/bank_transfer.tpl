<div class="heading widget-heading featured-heading large-heading-dropdown" id="<?php echo $widgetName; ?>Header">
    <div class="heading-title">
        <h3 onclick="$('#bankTransferGuide').slideToggle();">
            <i class="icon heading-icon fa fa-bank fa-2x"></i>
...
<div class="simple-form guide break" id="bankTransferGuide" style="display: none;">
    ...
    <form id="bankTransferForm" name="bankTransferForm" method="post">
        ...
        <div class="form-entry">
            ...
            <input type="text" name="bank_transfer_date_added" title="<?php echo $Language->get('help_bank_transfer_date_added'); ?>" value="" placeholder="Ingrese la fecha del dep&oacute;sito" required="required" />
        </div>
