<div class="heading widget-heading featured-heading large-heading-dropdown" id="<?php echo $widgetName; ?>Header">
    <div class="heading-title">
        <h3 onclick="$('#chequeGuide').slideToggle();">
            <i class="icon heading-icon fa fa-money fa-2x"></i>
...
<div class="simple-form guide break" id="chequeGuide" style="display: none;">
    ...
    <form id="chequeForm" name="chequeForm" method="post">
        ...
        <div class="form-entry">
            ...
            <input type="text" name="cheque_date_added" title="<?php echo $Language->get('help_cheque_date_added'); ?>" value="" placeholder="Ingrese la fecha del dep&oacute;sito" required="required" />
        </div>
