            ...
            <!--<?php if ($tags || $manufacturer || $categories) { ?>
                ...
                <form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" enctype="multipart/form-data" id="productForm">
                    ...
                    <div class="property quantity nt-editable" id="productQty">
                        ...
                        <a href="javascript:;"  class="arrow-up"><i data-action-count="inc" class="fa fa-plus"></i></a>
                        <a href="javascript:;"  class="arrow-down"  ><i data-action-count="dec" class="fa fa-minus"></i></a>
                    </div>
...
<script src="<?php echo HTTP_HOME . 'assets/theme/' . $this->config->get('config_template') . '/js/vendor/fancybox/jquery.fancybox.pack.js'; ?>"></script>
