<!--latest-widget -->
<?php if ($products) { ?>
<li class="nt-editable widget-product-list-<?php echo $settings['func']; ?> widget-product-list-<?php echo $settings['view']; ?> widget-product-list productListWidget<?php echo ($settings['class']) ? ' ' .$settings['class'] : ''; ?>" id="<?php echo $widgetName; ?>">
