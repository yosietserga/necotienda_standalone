<div class="container">
    <footer id="footer">
        <div class="grid_12">
            ...
            <ul class="widgets"><?php if ($widgets) { foreach ($widgets as $widget) { ?>{%<?php echo $widget; ?>%}<?php } } ?></ul>
...
$(function() {
    ...
    $('#cartPanel p').on('mouseover',function(e){
        $('#cartPanel ul').html('<img style="margin:20px 10px;" src="assets/images/loader.gif" alt="Cargando..." />').load('<?php echo $Url::createUrl("checkout/cart/callback"); ?>');
    });
