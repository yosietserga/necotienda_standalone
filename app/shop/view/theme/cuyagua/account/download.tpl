...
<section id="maincontent" class="nt-editable">
    ...
    <section id="content" class="nt-editable">
        ...
        <aside id="column_left" class="aside nt-editable"><?php echo $column_left; ?></aside>
        ...
        <div class="grid_13">
            ...
            <form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" enctype="multipart/form-data" id="form" class="nt-editable">
