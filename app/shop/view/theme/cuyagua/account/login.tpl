...
<section id="maincontent" class="row">
    ...
    <div class="large-12 medium-12 small-12 columns break">
        ...
        <ul class="account-form-tabs tabs">
            <li class="tab login-tab">
                <a href="#loginAction" class="tab-item"><?php echo $Language->get('text_returning_customer'); ?></a>
            </li>
            <li class="tab register-tab">
                <a href="#registerAction" class="tab-item"><?php echo $Language->get('text_i_am_new_customer'); ?></a>
            </li>
        </ul>
        <div class="access-actions">
            <div id="loginForm" class="access-action simple-form">
            ...
            <div id="registerForm" class="access-action">
