...
<script>
$(function(){
    window.fetchStyle('<?php echo HTTP_CSS; ?>sliders/neco-content-carousel.css');
    window.deferjQuery(function () {
        window.appendScriptSource("<?php echo HTTP_JS; ?>necojs/neco.contentCarousel.js");
    });
    window.deferPlugin('ntContentCarousel', function () {
