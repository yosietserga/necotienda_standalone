...
<section id="maincontent" class="row">
    <div class="cart-checkout">
        ...
        <div class="checkout-heading large-12 small-12 medium-12 columns">
            ...
            <span>
                <?php if ($weight) { ?>
                     <span id="weight">El peso de su carrito es:&nbsp;<?php echo $weight; ?></span>
                <?php } ?>
            </span>
        </div>
                                ...
                                <table class="cart-recipe">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td><a class="delete-product" onclick="deleteCart(this,'<?php echo $product['key']; ?>')" title="<?php echo $Language->get('text_delete'); ?>"><i class="fa fa-trash-o fa-2x"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
                            ...
                            <div class="recipe-info info-form">
                                <fieldset>
                                    ...
                                    <div class="property form-entry email-entry">
                                        ...
                                        <input type="email" name="email" id="email" placeholder="email..." value="<?php echo isset($email) ? $email : ''; ?>" required="required" title="<?php echo $Language->get('help_email'); ?>" <?php if ($isLogged) echo 'disabled="disabled"'; ?> />
                                    </div>

                                    <div class="property form-entry name-entry">
                                        <label for="firstname"><?php echo $Language->get('text_firstname'); ?>:</label>
                                        <input type="firstname" id="firstname" name="firstname" required="required" value="<?php echo isset($firstname) ? $firstname : ''; ?>"  <?php if ($isLogged) echo 'disabled="disabled"'; ?> />
                                    </div>

                                    <div class="property form-entry lastname-entry">
                                        <label for="lastname"><?php echo $Language->get('text_lastname'); ?>:</label>
                                        <input type="lastname" id="lastname" name="lastname" required="required" value="<?php echo isset($lastname) ? $lastname : ''; ?>"  <?php if ($isLogged) echo 'disabled="disabled"'; ?> />
                                    </div>

                                    <div class="property form-entry company-entry company-entry">
                                        <label for="company"><?php echo $Language->get('text_company'); ?>:</label>
                                        <input type="text" id="company" name="company" required="required" value="<?php echo isset($company) ? $company : ''; ?>"  <?php if ($isLogged) echo 'disabled="disabled"'; ?> />
                                    </div>
                                    ...
                                    <div class="property form-entry phone-entry">
                                        ...
                                        <input type="phone" id="telephone" name="telephone" required="required" value="<?php echo isset($telephone) ? $telephone : ''; ?>"  <?php if ($isLogged) echo 'disabled="disabled"'; ?> />
                                    </div>
                                    ...
                                    <div class="property form-entry refenceby-entry"<?php if ($isLogged) echo ' style="display:hidden"'; ?>>
                                        ...
                                        <input type="text" id="referencedBy" name="referencedBy" value="<?php echo isset($referencedBy) ? $referencedBy : ''; ?>" />
                                    </div>
                                    ...
                                    <div class="property form-entry">
                                        ...
                                        <input type="text" id="payment_postcode" name="payment_postcode" value="<?php echo $payment_postcode; ?>" required="required" title="<?php echo $Language->get('help_postcode'); ?>" />
                                    </div>
                        ...
                        <div class="payment-section row">
                            ...
                            <div class="shipping-data large-6 medium-6 small-12 columns data">
                                ...
                                <ul class="confirmOrder">
                                    <?php if ($shipping_methods) { ?>
                                    <li>
                                        <span>M&eacute;todo de Env&iacute;o:</span>
