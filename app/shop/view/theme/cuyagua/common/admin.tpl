                ...
                <div>
                    <table>
                        ...
                        <tr>
                            ...
                            <a id="underline" class="underline style-icons" onclick="setDecoration(this,'underline')"></a>
                            <a id="lineThrough" class="line-through style-icons" onclick="setDecoration(this,'line-through')"></a>
                            <input class="style-panel" type="hidden" id="textDecoration" name="Style[text-decoration]" value="" />
                                
                            <a id="upper" class="uppercase style-icons" onclick="setTransform(this,'uppercase')"></a>
                            <a id="lower" class="lowercase style-icons" onclick="setTransform(this,'lowercase')"></a>
