<?php echo $header; ?>
<?php echo $navigation; ?>
<section class="maincontent" class="row">
            ...
            <article>
                ...
                <div class="large-12 medium-12 small-12 columns">
                    <ul class="post-footer">
                        <li class="post-date" title="<?php echo $Language->get('text_created'); ?>"><?php echo $page['date_added']; ?></li>
                        <li class="post-rating" title="<?php echo $Language->get('text_rating'); ?>"><img src="<?php echo HTTP_IMAGE; ?>stars_<?php echo (int)$page['rating'] . '.png'; ?>" alt="<?php echo $page['stars']; ?>" /></li>
