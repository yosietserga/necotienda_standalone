<!--bestseller-widget -->
<?php if ($products) { ?>
<li class="nt-editable bestseller-widget<?php echo ($settings['class']) ? " ".$settings['class'] : ''; ?>" id="<?php echo $widgetName; ?>">

    <!--bestseller-widget-title -->
    ...
    <!-- /bestseller-widget-content -->
    <div class="widget-content bestseller-content" id="<?php echo $widgetName; ?>Content">
