        ...
        <div class="grid_13">
            ...
            <div class="box">
                <div class="content">
                    ...
                    <p id="storeAddress" class="nt-editable"><b><?php echo $Language->get('text_address'); ?></b>&nbsp;<?php echo $address; ?></p>
                    <?php if ($telephone) { ?><p id="storeTelephone" class="nt-editable"><b><?php echo $Language->get('text_telephone'); ?></b>&nbsp;<?php echo $telephone; ?></p><?php } ?>
                </div>
                    
                <?php if (isset($success)) { ?><div class="message success"><?php echo $success; ?></div><?php } ?>
                <form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" enctype="multipart/form-data" id="contact" class="nt-editable">
