...
<script>
    (function (w) {
        ...
        w.Constants = Object.freeze({
                    THEMECSS_PATH: '<?php echo HTTP_HOME . 'assets/' . $this->config->get('config_template ') . 'css /'?>',
                THEMEJS_PATH : '<?php echo HTTP_HOME . 'assets/' . $this->config->get('config_template ') . 'js/'?>',
                THEMEFONTS_PATH : '<?php echo HTTP_HOME . 'assets/' . $this->config->get('config_template ') . 'fonts/'?>',
                THEMEIMAGES_PATH : '<?php echo HTTP_HOME . 'assets/' . $this->config->get('config_template ') . 'images/'?>',
                THEMESVG_PATH : '<?php echo HTTP_HOME . 'assets/' . $this->config->get('config_template ') . 'svg-build/'?>',
