    ...
    <?php } else if ($column_left || $column_right) { ?>
        <img class="product-preview view" id="mainProduct" src="<?php echo $imagesCopy[0]['preview']; ?>" alt="<?php echo $heading_title; ?>" data-zoom-image="<?php echo $imagesCopy[0]['popup']; ?>"/>
    <?php } else { ?>
        <img class="product-preview view" id="mainProduct" src="<?php echo $imagesCopy[0]['preview']; ?>" alt="<?php echo $heading_title; ?>" data-zoom-image="<?php echo $imagesCopy[0]['popup']; ?>"/>
    <?php } ?>
