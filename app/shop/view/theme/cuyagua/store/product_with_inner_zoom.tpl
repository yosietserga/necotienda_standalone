...
<?php } ?>
    ...
    <section id="content">
        ...
        <ul class="tabs">
            ...
            <li class="tab" id="share">Social&iacute;zalo</li>
        </ul>
...
$(function(){
    ...
    jQuery('.tab').each(function(){
        ...
        jQuery('#_' + this.id).hide(); 
    });
    
    jQuery("#description").addClass('active');
    jQuery('#_description').show(); 
    ...
    jQuery('#review .pagination a').live('click', function() {
    	jQuery('#review').slideUp('slow').load(this.href).slideDown('slow');
    	return false;
    });
    
    jQuery("a.arrow-up").click(function() {
        var e = jQuery('#quantity');
        var v = jQuery(e).val();
        v++;
        jQuery(e).val(v);
    });
    ...
    jQuery('#review').load('index.php?r=store/product/review&product_id=<?php echo $product_id; ?>');
    jQuery('#related').load('index.php?r=store/product/related&product_id=<?php echo $product_id; ?>');
    jQuery('#comment').load('index.php?r=store/product/comment&product_id=<?php echo $product_id; ?>');
