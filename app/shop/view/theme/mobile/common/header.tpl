...
<section id="overheader" class="nt-editable container_16">
        <div class="grid_8">
        ...
        <div class="grid_3">
            <div id="currencies" class="nt-dd1 nt-editable">
                ...
                <p><span class="hideOnMobile">MONEDA:&nbsp;</span>
                <?php foreach ($currencies as $currency) { ?>
                    <?php if ($currency['code'] == $currency_code) { ?>
                    <b><span class="hideOnMobile"><?php echo $currency['title']; ?>&nbsp;</span><?php echo $currency['code']; ?></b>
                    <?php } ?>
                <?php } ?>
                    <span>&nbsp;</span>
                </p>
        ...
        <div class="grid_3">
            <div id="languages" class="nt-dd1 nt-editable">
                ...
                <p><span class="hideOnMobile">IDIOMA:&nbsp;</span>
                <?php foreach ($languages as $language) { ?>
                    <?php if ($language['code'] == $language_code) { ?>
                    <b><img src="<?php echo $language['image']; ?>" alt="<?php echo $language['name']; ?>" /><span class="hideOnMobile">&nbsp;&nbsp;<?php echo $language['name']; ?></span></b>
                    <?php } ?>
                <?php } ?>
                    <span>&nbsp;</span>
                </p>
...
<div class="container_16">
    <header id="header" class="nt-editable">
        ...
        <div class="grid_10" style="text-align:right;">
            ...
            <div id="accountPanel" class="nt-dd1 nt-editable hideOnMobile">
            ...
            <div id="cartPanel" class="nt-dd1 nt-editable hideOnMobile">
