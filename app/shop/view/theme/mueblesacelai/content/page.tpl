...
$(function(){
    ...
    $('#review').load('<?php echo $Url::createUrl("store/review") ."&object_type=page&object_id=". $page_id; ?>');
    $('#comment').load('<?php echo $Url::createUrl("store/review/comment") ."&object_type=page&object_id=". $page_id; ?>');
});
</script>
<?php echo $footer; ?>