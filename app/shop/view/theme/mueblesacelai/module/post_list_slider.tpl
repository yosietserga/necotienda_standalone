<?php if($posts) { ?>
<!-- post-list -->
<li class="nt-editable widget-post-list-<?php echo $settings['func']; ?> widget-post-list-<?php echo $settings['view']; ?> widget-post-slider postListWidget<?php echo ($settings['class']) ? ' ' .$settings['class'] : ''; ?>" id="<?php echo $widgetName; ?>">
