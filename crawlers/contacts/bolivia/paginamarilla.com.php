...
foreach ($categories as $cat) {
    ...
    if (!file_exists($filename)) {
        $doc = phpQuery::newDocumentHTML(fetch('http://bolivia.paginasamarillas.com/busqueda/' . $cat));
        ...
        if ((int) $limit > 0) {
            ...
            foreach ($pages as $page) {
                $links[] = 'http://bolivia.paginasamarillas.com/busqueda/' . $cat . '?Page=' . $page;
            }
        } else {
            $links[] = 'http://bolivia.paginasamarillas.com/busqueda/' . $cat;
        }
        var_dump($links);
