...
foreach ($categories as $cat) {
    ...
    if (!file_exists($filename)) {
        $doc = phpQuery::newDocumentHTML(fetch('http://chile.paginasamarillas.com/busqueda/' . $cat));
        ...
        if ((int) $limit > 0) {
            ...
            foreach ($pages as $page) {
                $links[] = 'http://chile.paginasamarillas.com/busqueda/' . $cat . '?Page=' . $page;
            }
        } else {
            $links[] = 'http://chile.paginasamarillas.com/busqueda/' . $cat;
        }
        var_dump($links);
