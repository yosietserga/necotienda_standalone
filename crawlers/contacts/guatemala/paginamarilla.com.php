...
foreach ($categories as $cat) {
    ...
    if (!file_exists($filename)) {
        $doc = phpQuery::newDocumentHTML(fetch('http://www.paginasamarillas.com.gt/busqueda/' . $cat));
        ...
        if ((int) $limit > 0) {
            ...
            foreach ($pages as $page) {
                $links[] = 'http://www.paginasamarillas.com.gt/busqueda/' . $cat . '?Page=' . $page;
            }
        } else {
            $links[] = 'http://www.paginasamarillas.com.gt/busqueda/' . $cat;
        }
        var_dump($links);
