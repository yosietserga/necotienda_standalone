...
--
-- Host: localhost
-- Generation Time: Mar 31, 2015 at 01:50 PM
...
--
-- Dumping data for table `nts_bank`
--

INSERT INTO `nts_bank` (`bank_id`, `name`, `image`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `nts_country`
--

INSERT INTO `nts_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `status`) VALUES
...
--
-- Dumping data for table `nts_currency`
--

INSERT INTO `nts_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1, 'Bolivar', 'VEF', 'Bs.', '', '2', 1.00000000, 1, '2015-02-03 20:48:00');

--
-- Dumping data for table `nts_customer_group`
--

INSERT INTO `nts_customer_group` (`customer_group_id`, `name`, `params`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Dumping data for table `nts_language`
--

INSERT INTO `nts_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`) VALUES
(1, 'Español', 'es', 'es_ES.UTF-8,es_ES,Espa', 've.png', 'spanish', 'spanish', 0, 1),
(3, 'Español Venezuela', 've', 'es_ve; es_419', 'es.png', 'spanish', 'spanish.php', 0, 1);

--
-- Dumping data for table `nts_length_class`
--

INSERT INTO `nts_length_class` (`length_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 10.00000000),
(3, 0.39370000),
(4, 100.00000000);
...
--
-- Dumping data for table `nts_length_class_description`
--

INSERT INTO `nts_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Cent', 'cm'),
(1, 3, 'Cent', 'cm'),
(2, 1, 'Mil', 'mm'),
(2, 3, 'Mil', 'mm'),
...
--
-- Dumping data for table `nts_setting`
--

INSERT INTO `nts_setting` (`setting_id`, `store_id`, `group`, `key`, `value`) VALUES
...
(49002, 0, 'flat', 'flat_cost', ''),
(49003, 0, 'flat', 'flat_tax_class_id', '0'),
(49004, 0, 'flat', 'flat_geo_zone_id', '0'),
(49005, 0, 'flat', 'flat_status', '0'),
(49006, 0, 'flat', 'flat_sort_order', ''),
(49008, 0, 'pickup', 'pickup_geo_zone_id', '0'),
(49009, 0, 'pickup', 'pickup_status', '1'),
(49010, 0, 'pickup', 'pickup_sort_order', ''),
(49017, 0, 'free', 'free_total', '500000'),
(49018, 0, 'free', 'free_geo_zone_id', '0'),
(49019, 0, 'free', 'free_status', '1'),
(49020, 0, 'free', 'free_sort_order', ''),
...
(49433, 0, 'weight', 'weight_tax_class_id', '0'),
(49434, 0, 'weight', 'weight_status', '1'),
(49435, 0, 'weight', 'weight_sort_order', ''),
(49436, 0, 'weight', 'weight_2_rate', '5:10.00'),
(49437, 0, 'weight', 'weight_2_status', '1'),
(49438, 0, 'weight', 'weight_1_rate', '1:60'),
(49439, 0, 'weight', 'weight_1_status', '1'),
...
(52339, 0, 'config', 'config_name', 'Mi tienda Nueva'),
(52340, 0, 'config', 'config_rif', 'J-29818520-1'),
(52341, 0, 'config', 'config_url', 'http://www.necoshop.com/tienda'),
(52342, 0, 'config', 'config_mobile_url', ''),
(52343, 0, 'config', 'config_tablet_url', ''),
(52344, 0, 'config', 'config_facebook_url', ''),
(52345, 0, 'config', 'config_owner', 'Yosiet Serga'),
(52346, 0, 'config', 'config_address', 'El Limón'),
(52347, 0, 'config', 'config_email', 'yosietserga@gmail.com'),
(52348, 0, 'config', 'config_replyto_email', 'yosietserga@gmail.com'),
(52349, 0, 'config', 'config_bounce_email', 'yosietserga@gmail.com'),
(52350, 0, 'config', 'config_telephone', '(0243) 245.16.01'),
(52351, 0, 'config', 'config_template', 'choroni'),
(52352, 0, 'config', 'config_mobile_template', 'choroni'),
(52353, 0, 'config', 'config_tablet_template', 'choroni'),
(52354, 0, 'config', 'config_facebook_template', 'choroni'),
(52355, 0, 'config', 'config_title_1', 'NecoTienda Standalone'),
(52356, 0, 'config', 'config_meta_description_1', ''),
(52357, 0, 'config', 'config_description_1', '&lt;p&gt;hello!!!&lt;/p&gt;\r\n'),
(52358, 0, 'config', 'config_title_3', ''),
(52359, 0, 'config', 'config_meta_description_3', ''),
(52360, 0, 'config', 'config_description_3', '&lt;p&gt;yeah&lt;/p&gt;\r\n'),
(52361, 0, 'config', 'config_country_id', '229'),
(52362, 0, 'config', 'config_zone_id', '3729'),
(52363, 0, 'config', 'config_language', 'es'),
(52364, 0, 'config', 'config_admin_language', 'es'),
(52365, 0, 'config', 'config_currency', 'VEF'),
(52366, 0, 'config', 'config_decimal_separator', ','),
(52367, 0, 'config', 'config_thousands_separator', '.'),
(52368, 0, 'config', 'config_currency_auto', '1'),
(52369, 0, 'config', 'config_store_mode', 'store'),
(52370, 0, 'config', 'config_admin_limit', '50'),
(52371, 0, 'config', 'config_catalog_limit', '24'),
(52372, 0, 'config', 'config_new_days', '5'),
(52373, 0, 'config', 'config_tax', '1'),
(52374, 0, 'config', 'config_customer_group_id', '1'),
(52375, 0, 'config', 'config_customer_price', '1'),
(52376, 0, 'config', 'config_customer_approval', '1'),
(52377, 0, 'config', 'config_account_id', '0'),
(52378, 0, 'config', 'config_checkout_id', '0'),
(52379, 0, 'config', 'config_stock_display', '1'),
(52380, 0, 'config', 'config_stock_checkout', '1'),
(52381, 0, 'config', 'config_order_payment_status_id', '1'),
(52382, 0, 'config', 'config_order_payment_status_approved', '3'),
(52383, 0, 'config', 'config_order_payment_status_returned', '5'),
(52384, 0, 'config', 'config_order_payment_status_no_approved', '4'),
(52385, 0, 'config', 'config_order_status_id', '1'),
(52386, 0, 'config', 'config_order_status_paid', '7'),
(52387, 0, 'config', 'config_order_status_loading', '3'),
(52388, 0, 'config', 'config_order_status_shipping', '6'),
(52389, 0, 'config', 'config_order_status_delivered', '4'),
(52390, 0, 'config', 'config_order_status_nulled', '8'),
(52391, 0, 'config', 'config_order_status_aborted', '2'),
(52392, 0, 'config', 'config_order_status_returned', '5'),
(52393, 0, 'config', 'config_stock_status_id', '8'),
(52394, 0, 'config', 'config_review', '1'),
(52395, 0, 'config', 'config_review_approve', '1'),
(52396, 0, 'config', 'config_download_status', '8'),
(52397, 0, 'config', 'config_cart_weight', '1'),
(52398, 0, 'config', 'config_shipping_session', '1'),
(52399, 0, 'config', 'config_logo', 'data/logo.png'),
(52400, 0, 'config', 'config_icon', 'data/favicon.png'),
(52401, 0, 'config', 'config_email_logo', ''),
(52402, 0, 'config', 'config_mobile_logo', ''),
(52403, 0, 'config', 'config_image_thumb_width', '350'),
(52404, 0, 'config', 'config_image_thumb_height', '350'),
(52405, 0, 'config', 'config_image_popup_width', '800'),
(52406, 0, 'config', 'config_image_popup_height', '800'),
(52407, 0, 'config', 'config_image_category_width', '20'),
(52408, 0, 'config', 'config_image_category_height', '200'),
(52409, 0, 'config', 'config_image_post_width', '200'),
(52410, 0, 'config', 'config_image_post_height', '200'),
(52411, 0, 'config', 'config_image_product_width', '200'),
(52412, 0, 'config', 'config_image_product_height', '200'),
(52413, 0, 'config', 'config_image_additional_width', '150'),
(52414, 0, 'config', 'config_image_additional_height', '150'),
(52415, 0, 'config', 'config_image_related_width', '150'),
(52416, 0, 'config', 'config_image_related_height', '150'),
(52417, 0, 'config', 'config_image_cart_width', '50'),
(52418, 0, 'config', 'config_image_cart_height', '50'),
(52419, 0, 'config', 'config_smtp_username', 'marketing+necotienda.org'),
(52420, 0, 'config', 'config_smtp_password', 'VmtSR1UxSnJOVVpOV0ZKVFlsZDRZVlJYZUVaUFVUMDk='),
(52421, 0, 'config', 'config_pop3_protocol', 'pop3'),
(52422, 0, 'config', 'config_pop3_host', 'mail.necotienda.org'),
(52423, 0, 'config', 'config_pop3_port', '110'),
(52424, 0, 'config', 'config_pop3_ssl', ''),
(52425, 0, 'config', 'config_bounce_process', 'on'),
(52426, 0, 'config', 'config_smtp_method', 'smtp'),
(52427, 0, 'config', 'config_smtp_host', 'mail.necotienda.org'),
(52428, 0, 'config', 'config_smtp_from_name', 'Yosiet Serga'),
(52429, 0, 'config', 'config_smtp_from_email', 'marketing@necotienda.org'),
(52430, 0, 'config', 'config_smtp_port', '25'),
(52431, 0, 'config', 'config_smtp_ssl', ''),
(52432, 0, 'config', 'config_smtp_auth', '1'),
(52433, 0, 'config', 'config_smtp_charset', 'utf-8'),
(52434, 0, 'config', 'config_smtp_timeout', '5'),
(52435, 0, 'config', 'config_smtp_maxsize', '0'),
(52436, 0, 'config', 'config_mail_parameter', ''),
(52437, 0, 'config', 'config_alert_mail', '1'),
(52438, 0, 'config', 'config_alert_emails', 'pedido nuevo'),
(52439, 0, 'config', 'config_bounce_server', 'mail.necotienda.org'),
(52440, 0, 'config', 'config_bounce_username', 'marketing+necotienda.org'),
(52441, 0, 'config', 'config_bounce_password', 'VmtSR1UxSnJOVVpOV0ZKVFlsZDRZVlJYZUVaUFVUMDk='),
(52442, 0, 'config', 'config_bounce_protocol', 'pop3'),
(52443, 0, 'config', 'config_js_security', '1'),
(52444, 0, 'config', 'config_server_security', '1'),
(52445, 0, 'config', 'config_seo_url', '1'),
(52446, 0, 'config', 'config_compression', '6'),
(52447, 0, 'config', 'config_error_display', '1'),
(52448, 0, 'config', 'config_error_log', '1'),
(52449, 0, 'config', 'config_error_filename', 'error.txt'),
(52450, 0, 'config', 'config_dir_export', ''),
(52451, 0, 'config', 'to', 'saveAndExit'),
(52452, 0, 'theme', 'theme_default_id', '3');

--
-- Dumping data for table `nts_stock_status`
--

INSERT INTO `nts_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Disponible'),
(1, 3, 'Disponible'),
(5, 1, 'Hasta Agotarse'),
(5, 3, 'Hasta Agotarse'),
...
--
-- Dumping data for table `nts_tax_class`
--

INSERT INTO `nts_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
(1, 'IVA', 'IVA', '2009-01-06 23:21:53', '2011-02-24 23:35:29');

--
-- Dumping data for table `nts_tax_rate`
--

INSERT INTO `nts_tax_rate` (`tax_rate_id`, `geo_zone_id`, `tax_class_id`, `priority`, `rate`, `description`, `date_modified`, `date_added`) VALUES
...
INSERT INTO `nts_user` (`user_id`, `user_group_id`, `username`, `password`, `firstname`, `lastname`, `email`, `status`, `ip`, `date_added`) VALUES
...
--
-- Dumping data for table `nts_user_group`
--

INSERT INTO `nts_user_group` (`user_group_id`, `name`, `permission`) VALUES
(1, 'Administrador', 'a:3:{s:6:"access";a:231:{i:0;s:11:"api/product";i:1;s:14:"chart/customer";i:2;s:11:"chart/order";i:3;s:13:"chart/product";i:4;s:15:"common/callback";i:5;s:18:"common/filemanager";i:6;s:14:"common/footer2";i:7;s:14:"common/header2";i:8;s:10:"common/nav";i:9;s:14:"content/banner";i:10;s:12:"content/file";i:11;s:12:"content/menu";i:12;s:12:"content/page";i:13;s:12:"content/post";i:14;s:21:"content/post_category";i:15;s:12:"cpanel/email";i:16;s:14:"extension/feed";i:17;s:16:"extension/module";i:18;s:17:"extension/payment";i:19;s:18:"extension/shipping";i:20;s:15:"extension/total";i:21;s:20:"localisation/country";i:22;s:21:"localisation/currency";i:23;s:21:"localisation/geo_zone";i:24;s:21:"localisation/language";i:25;s:25:"localisation/length_class";i:26;s:33:"localisation/order_payment_status";i:27;s:25:"localisation/order_status";i:28;s:25:"localisation/stock_status";i:29;s:22:"localisation/tax_class";i:30;s:25:"localisation/weight_class";i:31;s:17:"localisation/zone";i:32;s:16:"marketing/bounce";i:33;s:18:"marketing/campaign";i:34;s:17:"marketing/contact";i:35;s:14:"marketing/list";i:36;s:17:"marketing/message";i:37;s:20:"marketing/newsletter";i:38;s:21:"module/banner/install";i:39;s:23:"module/banner/uninstall";i:40;s:20:"module/banner/widget";i:41;s:24:"module/bestseller/config";i:42;s:25:"module/bestseller/install";i:43;s:27:"module/bestseller/uninstall";i:44;s:24:"module/bestseller/widget";i:45;s:23:"module/carousel/install";i:46;s:25:"module/carousel/uninstall";i:47;s:22:"module/carousel/widget";i:48;s:18:"module/cart/config";i:49;s:19:"module/cart/install";i:50;s:18:"module/cart/plugin";i:51;s:21:"module/cart/uninstall";i:52;s:18:"module/cart/widget";i:53;s:26:"module/catalog2pdf/install";i:54;s:28:"module/catalog2pdf/uninstall";i:55;s:25:"module/catalog2pdf/widget";i:56;s:22:"module/category/config";i:57;s:23:"module/category/install";i:58;s:25:"module/category/uninstall";i:59;s:22:"module/category/widget";i:60;s:17:"module/crm/config";i:61;s:18:"module/crm/install";i:62;s:22:"module/crm/opportunity";i:63;s:17:"module/crm/plugin";i:64;s:17:"module/crm/status";i:65;s:15:"module/crm/step";i:66;s:20:"module/crm/uninstall";i:67;s:17:"module/crm/widget";i:68;s:20:"module/fblike/config";i:69;s:21:"module/fblike/install";i:70;s:23:"module/fblike/uninstall";i:71;s:20:"module/fblike/widget";i:72;s:22:"module/featured/config";i:73;s:23:"module/featured/install";i:74;s:25:"module/featured/uninstall";i:75;s:22:"module/featured/widget";i:76;s:30:"module/google_analytics/config";i:77;s:31:"module/google_analytics/install";i:78;s:30:"module/google_analytics/plugin";i:79;s:33:"module/google_analytics/uninstall";i:80;s:25:"module/google_maps/config";i:81;s:26:"module/google_maps/install";i:82;s:28:"module/google_maps/uninstall";i:83;s:25:"module/google_maps/widget";i:84;s:25:"module/google_talk/config";i:85;s:26:"module/google_talk/install";i:86;s:25:"module/google_talk/plugin";i:87;s:28:"module/google_talk/uninstall";i:88;s:25:"module/google_talk/widget";i:89;s:28:"module/invitefriends/install";i:90;s:30:"module/invitefriends/uninstall";i:91;s:27:"module/invitefriends/widget";i:92;s:20:"module/latest/config";i:93;s:21:"module/latest/install";i:94;s:23:"module/latest/uninstall";i:95;s:20:"module/latest/widget";i:96;s:26:"module/layer_slider/config";i:97;s:27:"module/layer_slider/install";i:98;s:26:"module/layer_slider/plugin";i:99;s:29:"module/layer_slider/uninstall";i:100;s:26:"module/layer_slider/widget";i:101;s:23:"module/lightbox/install";i:102;s:25:"module/lightbox/uninstall";i:103;s:22:"module/lightbox/widget";i:104;s:19:"module/links/config";i:105;s:20:"module/links/install";i:106;s:22:"module/links/uninstall";i:107;s:19:"module/links/widget";i:108;s:19:"module/login/config";i:109;s:20:"module/login/install";i:110;s:22:"module/login/uninstall";i:111;s:19:"module/login/widget";i:112;s:26:"module/manufacturer/config";i:113;s:27:"module/manufacturer/install";i:114;s:29:"module/manufacturer/uninstall";i:115;s:26:"module/manufacturer/widget";i:116;s:18:"module/page/config";i:117;s:19:"module/page/install";i:118;s:21:"module/page/uninstall";i:119;s:18:"module/page/widget";i:120;s:24:"module/plaintext/install";i:121;s:26:"module/plaintext/uninstall";i:122;s:23:"module/plaintext/widget";i:123;s:29:"module/plugin_template/config";i:124;s:30:"module/plugin_template/install";i:125;s:29:"module/plugin_template/plugin";i:126;s:32:"module/plugin_template/uninstall";i:127;s:29:"module/plugin_template/widget";i:128;s:27:"module/product_list/install";i:129;s:29:"module/product_list/uninstall";i:130;s:26:"module/product_list/widget";i:131;s:26:"module/recommended/install";i:132;s:28:"module/recommended/uninstall";i:133;s:25:"module/recommended/widget";i:134;s:23:"module/richtext/install";i:135;s:25:"module/richtext/uninstall";i:136;s:22:"module/richtext/widget";i:137;s:19:"module/share/config";i:138;s:20:"module/share/install";i:139;s:19:"module/share/plugin";i:140;s:22:"module/share/uninstall";i:141;s:19:"module/share/widget";i:142;s:22:"module/skype_me/config";i:143;s:23:"module/skype_me/install";i:144;s:25:"module/skype_me/uninstall";i:145;s:22:"module/skype_me/widget";i:146;s:20:"module/social/config";i:147;s:21:"module/social/install";i:148;s:20:"module/social/plugin";i:149;s:23:"module/social/uninstall";i:150;s:20:"module/social/widget";i:151;s:21:"module/special/config";i:152;s:22:"module/special/install";i:153;s:24:"module/special/uninstall";i:154;s:21:"module/special/widget";i:155;s:32:"module/store_description/install";i:156;s:34:"module/store_description/uninstall";i:157;s:31:"module/store_description/widget";i:158;s:25:"module/store_logo/install";i:159;s:27:"module/store_logo/uninstall";i:160;s:24:"module/store_logo/widget";i:161;s:26:"module/store_title/install";i:162;s:28:"module/store_title/uninstall";i:163;s:25:"module/store_title/widget";i:164;s:23:"module/subscribe/config";i:165;s:24:"module/subscribe/install";i:166;s:26:"module/subscribe/uninstall";i:167;s:23:"module/subscribe/widget";i:168;s:21:"module/twitter/config";i:169;s:22:"module/twitter/install";i:170;s:24:"module/twitter/uninstall";i:171;s:21:"module/twitter/widget";i:172;s:21:"payment/bank_transfer";i:173;s:14:"payment/cheque";i:174;s:11:"payment/cod";i:175;s:13:"payment/debit";i:176;s:21:"payment/free_checkout";i:177;s:19:"payment/pp_standard";i:178;s:13:"report/visits";i:179;s:12:"sale/balance";i:180;s:9:"sale/bank";i:181;s:17:"sale/bank_account";i:182;s:11:"sale/coupon";i:183;s:15:"sale/cumpleanos";i:184;s:13:"sale/customer";i:185;s:18:"sale/customergroup";i:186;s:10:"sale/order";i:187;s:12:"sale/payment";i:188;s:13:"setting/cache";i:189;s:15:"setting/setting";i:190;s:13:"shipping/flat";i:191;s:13:"shipping/free";i:192;s:13:"shipping/item";i:193;s:15:"shipping/pickup";i:194;s:15:"shipping/weight";i:195;s:14:"store/category";i:196;s:14:"store/download";i:197;s:18:"store/manufacturer";i:198;s:13:"store/product";i:199;s:12:"store/review";i:200;s:11:"store/store";i:201;s:12:"style/editor";i:202;s:13:"style/layouts";i:203;s:14:"style/template";i:204;s:11:"style/theme";i:205;s:11:"style/views";i:206;s:12:"style/widget";i:207;s:16:"support/feedback";i:208;s:11:"tool/backup";i:209;s:8:"tool/csv";i:210;s:14:"tool/error_log";i:211;s:10:"tool/excel";i:212;s:12:"tool/restore";i:213;s:11:"tool/update";i:214;s:10:"tool/vcard";i:215;s:12:"total/coupon";i:216;s:14:"total/handling";i:217;s:19:"total/low_order_fee";i:218;s:14:"total/shipping";i:219;s:15:"total/sub_total";i:220;s:9:"total/tax";i:221;s:11:"total/total";i:222;s:9:"user/user";i:223;s:20:"user/user_permission";i:224;s:13:"widgets/order";i:225;s:19:"widgets/order_stats";i:226;s:21:"widgets/server_status";i:227;s:14:"widgets/update";i:228;s:27:"module/product_list/install";i:229;s:29:"module/product_list/uninstall";i:230;s:26:"module/product_list/widget";}s:6:"modify";a:231:{i:0;s:11:"api/product";i:1;s:14:"chart/customer";i:2;s:11:"chart/order";i:3;s:13:"chart/product";i:4;s:15:"common/callback";i:5;s:18:"common/filemanager";i:6;s:14:"common/footer2";i:7;s:14:"common/header2";i:8;s:10:"common/nav";i:9;s:14:"content/banner";i:10;s:12:"content/file";i:11;s:12:"content/menu";i:12;s:12:"content/page";i:13;s:12:"content/post";i:14;s:21:"content/post_category";i:15;s:12:"cpanel/email";i:16;s:14:"extension/feed";i:17;s:16:"extension/module";i:18;s:17:"extension/payment";i:19;s:18:"extension/shipping";i:20;s:15:"extension/total";i:21;s:20:"localisation/country";i:22;s:21:"localisation/currency";i:23;s:21:"localisation/geo_zone";i:24;s:21:"localisation/language";i:25;s:25:"localisation/length_class";i:26;s:33:"localisation/order_payment_status";i:27;s:25:"localisation/order_status";i:28;s:25:"localisation/stock_status";i:29;s:22:"localisation/tax_class";i:30;s:25:"localisation/weight_class";i:31;s:17:"localisation/zone";i:32;s:16:"marketing/bounce";i:33;s:18:"marketing/campaign";i:34;s:17:"marketing/contact";i:35;s:14:"marketing/list";i:36;s:17:"marketing/message";i:37;s:20:"marketing/newsletter";i:38;s:21:"module/banner/install";i:39;s:23:"module/banner/uninstall";i:40;s:20:"module/banner/widget";i:41;s:24:"module/bestseller/config";i:42;s:25:"module/bestseller/install";i:43;s:27:"module/bestseller/uninstall";i:44;s:24:"module/bestseller/widget";i:45;s:23:"module/carousel/install";i:46;s:25:"module/carousel/uninstall";i:47;s:22:"module/carousel/widget";i:48;s:18:"module/cart/config";i:49;s:19:"module/cart/install";i:50;s:18:"module/cart/plugin";i:51;s:21:"module/cart/uninstall";i:52;s:18:"module/cart/widget";i:53;s:26:"module/catalog2pdf/install";i:54;s:28:"module/catalog2pdf/uninstall";i:55;s:25:"module/catalog2pdf/widget";i:56;s:22:"module/category/config";i:57;s:23:"module/category/install";i:58;s:25:"module/category/uninstall";i:59;s:22:"module/category/widget";i:60;s:17:"module/crm/config";i:61;s:18:"module/crm/install";i:62;s:22:"module/crm/opportunity";i:63;s:17:"module/crm/plugin";i:64;s:17:"module/crm/status";i:65;s:15:"module/crm/step";i:66;s:20:"module/crm/uninstall";i:67;s:17:"module/crm/widget";i:68;s:20:"module/fblike/config";i:69;s:21:"module/fblike/install";i:70;s:23:"module/fblike/uninstall";i:71;s:20:"module/fblike/widget";i:72;s:22:"module/featured/config";i:73;s:23:"module/featured/install";i:74;s:25:"module/featured/uninstall";i:75;s:22:"module/featured/widget";i:76;s:30:"module/google_analytics/config";i:77;s:31:"module/google_analytics/install";i:78;s:30:"module/google_analytics/plugin";i:79;s:33:"module/google_analytics/uninstall";i:80;s:25:"module/google_maps/config";i:81;s:26:"module/google_maps/install";i:82;s:28:"module/google_maps/uninstall";i:83;s:25:"module/google_maps/widget";i:84;s:25:"module/google_talk/config";i:85;s:26:"module/google_talk/install";i:86;s:25:"module/google_talk/plugin";i:87;s:28:"module/google_talk/uninstall";i:88;s:25:"module/google_talk/widget";i:89;s:28:"module/invitefriends/install";i:90;s:30:"module/invitefriends/uninstall";i:91;s:27:"module/invitefriends/widget";i:92;s:20:"module/latest/config";i:93;s:21:"module/latest/install";i:94;s:23:"module/latest/uninstall";i:95;s:20:"module/latest/widget";i:96;s:26:"module/layer_slider/config";i:97;s:27:"module/layer_slider/install";i:98;s:26:"module/layer_slider/plugin";i:99;s:29:"module/layer_slider/uninstall";i:100;s:26:"module/layer_slider/widget";i:101;s:23:"module/lightbox/install";i:102;s:25:"module/lightbox/uninstall";i:103;s:22:"module/lightbox/widget";i:104;s:19:"module/links/config";i:105;s:20:"module/links/install";i:106;s:22:"module/links/uninstall";i:107;s:19:"module/links/widget";i:108;s:19:"module/login/config";i:109;s:20:"module/login/install";i:110;s:22:"module/login/uninstall";i:111;s:19:"module/login/widget";i:112;s:26:"module/manufacturer/config";i:113;s:27:"module/manufacturer/install";i:114;s:29:"module/manufacturer/uninstall";i:115;s:26:"module/manufacturer/widget";i:116;s:18:"module/page/config";i:117;s:19:"module/page/install";i:118;s:21:"module/page/uninstall";i:119;s:18:"module/page/widget";i:120;s:24:"module/plaintext/install";i:121;s:26:"module/plaintext/uninstall";i:122;s:23:"module/plaintext/widget";i:123;s:29:"module/plugin_template/config";i:124;s:30:"module/plugin_template/install";i:125;s:29:"module/plugin_template/plugin";i:126;s:32:"module/plugin_template/uninstall";i:127;s:29:"module/plugin_template/widget";i:128;s:27:"module/product_list/install";i:129;s:29:"module/product_list/uninstall";i:130;s:26:"module/product_list/widget";i:131;s:26:"module/recommended/install";i:132;s:28:"module/recommended/uninstall";i:133;s:25:"module/recommended/widget";i:134;s:23:"module/richtext/install";i:135;s:25:"module/richtext/uninstall";i:136;s:22:"module/richtext/widget";i:137;s:19:"module/share/config";i:138;s:20:"module/share/install";i:139;s:19:"module/share/plugin";i:140;s:22:"module/share/uninstall";i:141;s:19:"module/share/widget";i:142;s:22:"module/skype_me/config";i:143;s:23:"module/skype_me/install";i:144;s:25:"module/skype_me/uninstall";i:145;s:22:"module/skype_me/widget";i:146;s:20:"module/social/config";i:147;s:21:"module/social/install";i:148;s:20:"module/social/plugin";i:149;s:23:"module/social/uninstall";i:150;s:20:"module/social/widget";i:151;s:21:"module/special/config";i:152;s:22:"module/special/install";i:153;s:24:"module/special/uninstall";i:154;s:21:"module/special/widget";i:155;s:32:"module/store_description/install";i:156;s:34:"module/store_description/uninstall";i:157;s:31:"module/store_description/widget";i:158;s:25:"module/store_logo/install";i:159;s:27:"module/store_logo/uninstall";i:160;s:24:"module/store_logo/widget";i:161;s:26:"module/store_title/install";i:162;s:28:"module/store_title/uninstall";i:163;s:25:"module/store_title/widget";i:164;s:23:"module/subscribe/config";i:165;s:24:"module/subscribe/install";i:166;s:26:"module/subscribe/uninstall";i:167;s:23:"module/subscribe/widget";i:168;s:21:"module/twitter/config";i:169;s:22:"module/twitter/install";i:170;s:24:"module/twitter/uninstall";i:171;s:21:"module/twitter/widget";i:172;s:21:"payment/bank_transfer";i:173;s:14:"payment/cheque";i:174;s:11:"payment/cod";i:175;s:13:"payment/debit";i:176;s:21:"payment/free_checkout";i:177;s:19:"payment/pp_standard";i:178;s:13:"report/visits";i:179;s:12:"sale/balance";i:180;s:9:"sale/bank";i:181;s:17:"sale/bank_account";i:182;s:11:"sale/coupon";i:183;s:15:"sale/cumpleanos";i:184;s:13:"sale/customer";i:185;s:18:"sale/customergroup";i:186;s:10:"sale/order";i:187;s:12:"sale/payment";i:188;s:13:"setting/cache";i:189;s:15:"setting/setting";i:190;s:13:"shipping/flat";i:191;s:13:"shipping/free";i:192;s:13:"shipping/item";i:193;s:15:"shipping/pickup";i:194;s:15:"shipping/weight";i:195;s:14:"store/category";i:196;s:14:"store/download";i:197;s:18:"store/manufacturer";i:198;s:13:"store/product";i:199;s:12:"store/review";i:200;s:11:"store/store";i:201;s:12:"style/editor";i:202;s:13:"style/layouts";i:203;s:14:"style/template";i:204;s:11:"style/theme";i:205;s:11:"style/views";i:206;s:12:"style/widget";i:207;s:16:"support/feedback";i:208;s:11:"tool/backup";i:209;s:8:"tool/csv";i:210;s:14:"tool/error_log";i:211;s:10:"tool/excel";i:212;s:12:"tool/restore";i:213;s:11:"tool/update";i:214;s:10:"tool/vcard";i:215;s:12:"total/coupon";i:216;s:14:"total/handling";i:217;s:19:"total/low_order_fee";i:218;s:14:"total/shipping";i:219;s:15:"total/sub_total";i:220;s:9:"total/tax";i:221;s:11:"total/total";i:222;s:9:"user/user";i:223;s:20:"user/user_permission";i:224;s:13:"widgets/order";i:225;s:19:"widgets/order_stats";i:226;s:21:"widgets/server_status";i:227;s:14:"widgets/update";i:228;s:27:"module/product_list/install";i:229;s:29:"module/product_list/uninstall";i:230;s:26:"module/product_list/widget";}s:6:"delete";a:1:{i:0;s:26:"module/product_list/widget";}}'),
...
--
-- Dumping data for table `nts_weight_class`
--

INSERT INTO `nts_weight_class` (`weight_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 1000.00000000),
(5, 2.20460000),
(6, 35.27400000);
...
--
-- Dumping data for table `nts_weight_class_description`
--

INSERT INTO `nts_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogramo', 'kg'),
(1, 3, 'Kilogramo', 'kg'),
(2, 1, 'Gramo', 'g'),
(2, 3, 'Gramo', 'g'),
...
--
-- Dumping data for table `nts_zone`
--

INSERT INTO `nts_zone` (`zone_id`, `country_id`, `code`, `name`, `status`) VALUES
...
--
-- Dumping data for table `nts_zone_to_geo_zone`
--

INSERT INTO `nts_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
