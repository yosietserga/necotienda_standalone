$(function () {
    ...
    $("#margin").on('change', function (event) {
        $("#marginSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#marginTop").on('change', function (event) {
        $("#marginTopSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#marginRight").on('change', function (event) {
        $("#marginRightSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#marginBottom").on('change', function (event) {
        $("#marginBottomSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#marginLeft").on('change', function (event) {
        $("#marginLeftSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#padding").on('change', function (event) {
        $("#paddingSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#paddingTop").on('change', function (event) {
        $("#paddingTopSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#paddingRight").on('change', function (event) {
        $("#paddingRightSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#paddingBottom").on('change', function (event) {
        $("#paddingBottomSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#paddingLeft").on('change', function (event) {
        $("#paddingLeftSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#top").on('change', function (event) {
        $("#topSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#leftSlider").slider({
        range: "min",
        min: -width,
    ...
    $("#left").on('change', function (event) {
        $("#leftSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#widthSlider").slider({
        range: "min",
        min: 0,
    ...
    $("#width").on('change', function (event) {
        $("#widthSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#heightSlider").slider({
        range: "min",
        min: 0,
    ...
    $("#height").on('change', function (event) {
        $("#heightSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#borderRadius").on('change', function (event) {
        $("#borderRadiusSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#borderRadiusTopLeft").on('change', function (event) {
        $("#borderRadiusTopLeftSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#borderRadiusTopRight").on('change', function (event) {
        $("#borderRadiusTopRightSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#borderRadiusBottomLeft").on('change', function (event) {
        $("#borderRadiusBottomLeftSlider").slider('option', 'value', parseInt(this.value));
    });
    $("#borderRadiusBottomRight").on('change', function (event) {
        $("#borderRadiusBottomRightSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#borderWidth").on('change', function (event) {
        $("#borderWidthSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#borderTopWidth").on('change', function (event) {
        $("#borderTopWidthSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#borderRightWidth").on('change', function (event) {
        $("#borderRightWidthSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#borderBottomWidth").on('change', function (event) {
        $("#borderBottomWidthSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#borderLeftWidth").on('change', function (event) {
        $("#borderLeftWidthSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#boxShadowX").on('change', function (event) {
        $("#boxShadowXSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#boxShadowY").on('change', function (event) {
        $("#boxShadowYSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#boxShadowBlur").on('change', function (event) {
        $("#boxShadowBlurSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#boxShadowSpread").on('change', function (event) {
        $("#boxShadowSpreadSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#letterSpacing").on('change', function (event) {
        $("#letterSpacingSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#wordSpacing").on('change', function (event) {
        $("#wordSpacingSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    $("#lineHeight").on('change', function (event) {
        $("#lineHeightSlider").slider('option', 'value', parseInt(this.value));
    });
    ...
    if (elements) {
        $.each(elements, function (el, style) {
            ...
            if (style.font.weight == 'bold' || style.font.weight == '700') {
                $('#bold').addClass('boldOn');
            } else {
                $('#bold').removeClass('boldOn');
            }
            if (style.font.style == 'italic') {
                $('#italic').addClass('italicOn');
            } else {
                $('#italic').removeClass('italicOn');
            }
            if (style.font.decoration == 'underline') {
                $('#underline').addClass('underlineOn');
            }
            if (style.font.decoration == 'line-through') {
                $('#lineThrough').addClass('line-throughOn');
            }
            if (style.font.transform == 'uppercase') {
                $('#upper').addClass('uppercaseOn');
            }
            if (style.font.transform == 'lowercase') {
                $('#lower').addClass('lowercaseOn');
            }
            if (style.font.align == 'left') {
                $('#alignLeft').addClass('align-leftOn');
            }
            if (style.font.align == 'center') {
                $('#alignCenter').addClass('align-centerOn');
            }
            if (style.font.align == 'right') {
                $('#alignRight').addClass('align-rightOn');
            }
            if (style.font.align == 'justify') {
                $('#alignJustify').addClass('align-justifyOn');
            }
...
function setStyle() {
    ...
    if ($('#borderRadiusAdvanced').val() == 0) {
        ...
        if ($('#borderRadiusTopLeft').val()) {
            ...
            cssBorderRadius += $('#borderRadiusTopLeft').val();
        } else {
        ...
        if ($('#borderRadiusTopRight').val()) {
            ...
            cssBorderRadius += $('#borderRadiusTopRight').val();
        } else {
        ...
        if ($('#borderRadiusBottomRight').val()) {
            ...
            cssBorderRadius += $('#borderRadiusBottomRight').val();
        } else {
        ...
        if ($('#borderRadiusBottomLeft').val()) {
            ...
            cssBorderRadius += $('#borderRadiusBottomLeft').val();
        } else {
    ...
    if ($('#letterSpacing').val()) {
        style.font.letterspacing = $('#letterSpacing').val();
        $(that).css('letterSpacing', $('#letterSpacing').val());
    }
    if ($('#wordSpacing').val()) {
        style.font.wordspacing = $('#wordSpacing').val();
        $(that).css('wordSpacing', $('#wordSpacing').val());
    }
    if ($('#lineHeight').val()) {
        style.font.lineheight = $('#lineHeight').val();
