...
{var defaults={  leftBtn : 'http://www.necoyoad.com/cdn/inecoyoad/img/cs_leftImg.png',     rightBtn : 'http://www.necoyoad.com/cdn/inecoyoad/img/cs_rightImg.png',     width : '650px',     height : '400px',     speed : 400,     easing : 'easeOutQuad',     textResize : false,     IE_h2 : '26px',     IE_p : '11px'
   }
 ...
 { var l=parseInt(b.siblings('.cs_wrapper').children('.cs_slider').css('left'));
      ...
      if(m<=0&&m>=x){    b
          .siblings('.cs_wrapper')
            .children('.cs_slider')
              .animate({'left':m+'px'},o.speed,o.easing,function(){            inuse=false;
             });

        if(b.attr('class')=='cs_leftBtn'){      var thisBtn=$('#'+thisInstance+' .cs_leftBtn');
          var otherBtn=$('#'+thisInstance+' .cs_rightBtn');
       } else{      var thisBtn=$('#'+thisInstance+' .cs_rightBtn');
    ...
    return this.each(function(){  $(this)
      ...
      if(o.textResize===true){    var h2FontSize=$(this).find('h2').css('font-size');
        var pFontSize=$(this).find('p').css('font-size');
        $.each(jQuery.browser,function(i){      if($.browser.msie){         h2FontSize=o.IE_h2;
             pFontSize=o.IE_p;
         }
       });
      ...
      leftBtn.bind('click',function(){    if(inuse===false){      inuse=true;
      ...
      rightBtn.bind('click',function(){    if(inuse===false){      inuse=true;
