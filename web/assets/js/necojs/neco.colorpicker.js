    ...
    $.fn.ntColorPicker = function(method) {
        ...
        var helpers = {
            _create: function() {
                ...
                $(".neco-color-picker-launch").on('click',function(){
                    $(".neco-color-picker-launch").each(function(){
            ...
            _widgetCoords: function (event) {
                ...
                if (typeof event.offsetX != 'undefined') {
                  ...
                  var pos = helpers._absolutePosition(reference);
                  x = (event.pageX || 0*(event.clientX + $('html').get(0).scrollLeft)) - pos.x;
                  y = (event.pageY || 0*(event.clientY + $('html').get(0).scrollTop)) - pos.y;
                }
                // Subtract distance to middle
                return { x: x - data.width / 2, y: y - data.width / 2 };
            },
