/* PLUGINS.js */
var KFWPluginsVersion = '2.0.20110707'; /* animate background-position */
(function($) {
...
(function($) {
	$.fn.imgJustify = function(p) {
		...
		function loadImages() {
			...
			for (x = g.firstImg;
			(o.width > g.tempAllWidth && x < g.allImg + 1); x++) {
		...
		return this.find('a[href*="#"]').each(function() {
			...
			$(this).click(function(event) {
				...
				$('html:not(:animated),body:not(:animated)').animate({
					scrollTop: $('html a[name="' + num + '"]').offset().top
				}, o.animTime, o.animType, function() {
					if (o.addHash == true) {
